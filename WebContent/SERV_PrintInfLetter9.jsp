...
<!--
  function PrintLetter(frm) {
	 frm.target = "_blank";
	 frm.action = "https://www7.lh.co.th/LHServ/PrintInfLetter9Servlet";
     frm.submit();
	 frm.target = "_self";
  }
  function ChangeYear(frm) {
	 frm.action = "/LHServ/SERV_PrintInfLetter9.jsp";
     frm.submit();
  }
...
<FORM NAME="frmLetter" METHOD=POST ACTION="SERV_PrintInfLetter2.jsp">
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				<td width="50%" class="bigh"><img border="0"
					src="images/i_home.gif" align="absmiddle" width="20" height="20">&nbsp;จดหมายแจ้งกำหนดการเริ่มจัดเก็บค่าบริการสาธารณะ</td>
...
String inf_year = doString.checkString(request.getParameter("inf_year"));
if (inf_year.equals("")) {
	inf_year = cur_year;
}
String year = Integer.toString(Integer.parseInt(inf_year)-543);
String beg_date = "01/01/" + year;
String end_date = "31/12/" + year;
...
%>
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td class="item_tab2" width="250">จดหมายแจ้งการจัดเก้บค่าบริการสาธารณะประจำปี</td>
			...
			<tr>
				...
				<table border="0" width="100%" cellspacing="0" cellpadding="0">
                  ...
                  <td class="item ; dotline01" height="22" width="20%">โครงการ 
                    :</td>
                  <td height="22" class="dotline01" width="80%">
...
%>                                          
					...
					<tr>					
                  <td class="item ; dotline01" height="22" width="20%">ประจำปี :</td>
						
                  <td height="22" class="dotline01" width="80%">
			<select size="1" name="inf_year" class="box" style="width:80px" onChange="ChangeYear(frmLetter)">
<%
	int curYear = Integer.parseInt(inf_year);
	int Byear = curYear - 5;
	int Eyear = curYear + 5;
...
%> 
					...
					<tr>					
                  <td class="item ; dotline01" height="22" width="20%">ลงวันที่
                    :</td>
                  <td height="22" class="dotline01" width="80%"><%date_util.printHtmlThaiDateNoTime(out, "Prnt", "", 5, 2, "white", "#0078FF");%></td>
					</tr>	
					
					<tr>					
                  <td class="item ; dotline01" height="22" width="20%">อ้างถึงหนังสือประจำปี
                    :</td>
                  <td height="22" class="dotline01" width="80%"><%date_util.printHtmlThaiDateNoTime(out, "refer_start", beg_date, 5, 2, "white", "#0078FF");%> ถึง <%date_util.printHtmlThaiDateNoTime(out, "refer_end", end_date, 5, 2, "white", "#0078FF");%></td>
					</tr>
					
					<tr>					
                  <td class="item ; dotline01" height="22" width="20%">วันที่ส่งมอบนิติ
                    :</td>
                  <td height="22" class="dotline01" width="80%"><%date_util.printHtmlThaiDateNoTime(out, "deliver_date", "", 5, 2, "white", "#0078FF");%></td>
					</tr>
					
					<tr>					
                  <td class="item ; dotline01" height="22" width="20%">ขอจัดเก็บตั้งแต่
                    :</td>
                  <td height="22" class="dotline01" width="80%"><%date_util.printHtmlThaiDateNoTime(out, "request_start", beg_date, 5, 2, "white", "#0078FF");%> ถึง <%date_util.printHtmlThaiDateNoTime(out, "request_end", end_date, 5, 2, "white", "#0078FF");%></td>
					</tr>
					
					<tr>					
                  <td class="item ; dotline01" height="22" width="20%">วันที่จัดเก็บที่เหลือ
                    :</td>
                  <td height="22" class="dotline01" width="80%"><%date_util.printHtmlThaiDateNoTime(out, "remain_start", beg_date, 5, 2, "white", "#0078FF");%> ถึง <%date_util.printHtmlThaiDateNoTime(out, "remain_end", end_date, 5, 2, "white", "#0078FF");%></td>
					</tr>
														
					
					<tr>
                  <td class="item ; dotline01" height="22" width="20%">ชื่อผู้ติดต่อ :</td>
                  <td height="22" class="dotline01" width="80%"><input type="text" name="Contact" class="box" style="width:250px" value=""></td>
					</tr>										
					<tr>					
                  <td class="item ; dotline01" height="22" width="20%">เบอร์โทรศัพท์ :</td>
                  <td height="22" class="dotline01" width="80%"><input type="text" name="Phone" class="box" style="width:250px" value=""></td>
					</tr>						
				</table>
				</td>
			</tr>
...
<%
		...
		System.out.println("ERROR SERV_PrintInfLetter2.jsp : " + e.getMessage());
