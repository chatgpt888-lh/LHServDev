...
String venId = doString.checkString(request.getParameter("Vendor"));
String retenType = "";
String pname = "";
String name = "";
String sname = "";
...
if (vendor != null) {
	retenType = vendor.getType();
	if (!type.equals(retenType)) {
		vendor.setType("");
		vendor.setId("");
		vendor.setPreName("");
		vendor.setName("");
...
<HTML>
<HEAD>
<TITLE>Add - ใบวางเงินค้ำประกันการปลูกสร้างอาคารหรือต่อเติม</TITLE>
...
{
	frm.action="/LHServ/AddVendorServlet";
	frm.submit();
}
// End -->
</script>
...
<FORM name="frmCustReten" method="post" action="SERV_CustReten.jsp">
...
try {
	...
	if (search.equals("true")) {
		sql = "SELECT n_pname, n_name, n_sname, i_tel FROM lan:serv_venprj WHERE i_company = '"+comId+"' AND i_project = '"+projId+"' AND i_type = '"+type+"' AND i_vendor = '"+venId+"'";
      ...
      <TABLE border="0" width="100%" cellspacing="0" cellpadding="0">
        <TBODY>
          <TR>
            ...
            <TD class="item_tab2" width="200">รายละเอียดผู้วางเงินค้ำประกันฯ</TD>
        ...
        <TBODY>
          <TR>
            ...
            <TABLE border="0" width="100%" cellspacing="0" cellpadding="0">
              <TBODY> 
              <TR> 
                <TD class="item ; dotline01" height="22" width="17%">ผู้วางเงินค้ำประกัน 
                  :</TD>
                ...
                <TD height="22" width="35%" class="dotline01"> 
                  <SELECT class="box" style="width:200px" name="Vendor" onChange="Search(frmCustReten)">
              <OPTION value="">. . .</OPTION>
...
%>
              ...
              <TR> 
                <TD class="item ; dotline01" height="22" width="17%">รหัสผู้วางเงินฯ 
                  :</TD>
                <TD height="22" width="35%" class="dotline01"> 
...
<%
	...
	System.out.println("ERROR SERV_CustReten.jsp : " + e.getMessage());
      ...
      <TABLE border="0" width="100%" cellspacing="0" cellpadding="0" height="30">
        <TBODY>
          <TR>
            ...
            <TD width="75" class="act_tab2"><A href="javascript:addVendor(frmCustReten)"><IMG border="0" src="images/act_saveandclose.gif" onmouseout="nereidFade(this,70,50,5)" onmouseover="nereidFade(this,100,50,5)" style="FILTER: alpha(opacity=70)" width="70" height="27"></A></TD>
