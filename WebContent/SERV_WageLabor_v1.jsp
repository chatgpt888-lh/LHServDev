...
String jName = "SERV_WageLabor_v1.jsp";
...
function submit()  {		
		Wage.action = "/LHServ/SERV_WageLabor_v1.jsp";
		Wage.submit();
}
...
<FORM NAME="Wage" METHOD="POST" ACTION="SERV_WageLabor_v1.jsp">
...
%>
    ...
    <td class="dotlineREP ; item"><!--<A HREF="SERV_WageEdit.jsp?card_no=<%=doString.checkString(rs.getString("i_cardno"))%>&YY=<%=YY%>&YY1=<%=YY1%>&MM=<%=MM%>&MM1=<%=MM1%>&day1=<%=day1%>&project=<%=project%>">--><%=doString.checkString(doString.DisplayThai(rs.getString("i_name")))%><!--</A>&nbsp;--></td>
...
<%
		...
		System.out.println("ERROR SERV_WageLabor_v1.jsp : " + e.getMessage());
