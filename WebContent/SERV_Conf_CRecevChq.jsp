...
String jName = "SERV_Conf_CRecevChq.jsp";
ServLog servlog = new ServLog(sessionId, userId, jName);
   ...
   String condition = "";
	...
	sql.append(" select b.i_company||b.i_project||' | '||b.n_project as project_name , c.n_desc , e.c_apprv , f.c_apprv as  c_prev_apprv , ")
	      ...
	      .append(" where a.i_doc_status in ('K','E') and a.z_reten=a.z_recv_reten and a.i_staff_payback is not null ")
	...
	while (rs.next()) {
	     ...
	     if (iDocStatus.equals("E")) {
	        nRecvChq = doString.checkString(doString.DisplayThai(rs.getString("n_recv_chq")),"");
	     } else {
	        nRecvChq = empName;
	     }
...
function confirmCheque() {
     if (confirm("คุณแน่ใจว่าต้องการบันทึกการรับเช็คใบนี้  ?")) {
        document.forms[0].action_flag.value="E";
...
<input type="hidden" name="action_flag" value="E">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td height="22" class="item ; dotline01" width="16%">ผู้รับเช็ค</td>
    <td height="22" width="30%" class="dotline01"><input type="text" name="n_recv_chq" <%=iDocStatus.equals("K") ? "" : " disabled " %> value="<%=doString.checkString(nRecvChq,"-")%>" class="box" style="width:200px" ></td>
  </tr>
</table>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" height="30">
          <tr>
            ...
            <td width="75" class="act_tab2">
             <%
	       if (iDocStatus.equals("K")) {
	     %>		
            <img border="0" src="images/act_saveandclose.gif"  onclick="confirmCheque();"
