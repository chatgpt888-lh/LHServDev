 ...
 * @author
 */
public class SERV_ZoneConfServlet extends DBServlet  {
			...
			if (mode.equalsIgnoreCase("APPROVE_VENDOR")) {
				...
				if (vendorList!=null) {
					for (int i=0;i<vendorList.length;i++) {
							...
							System.out.println("Get Vendor["+i+"]="+vendor);		
					    ...
					    sql.append(" select distinct b.i_docno from lan:serv_dochd a,lan:serv_payment b ")
