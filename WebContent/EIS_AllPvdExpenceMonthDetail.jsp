...
%>
<FORM NAME="frmEIS" METHOD=POST ACTION="EIS_AllPvdExpenceMonthDetail.jsp">
...
<br style="font-size:5pt">  
  ...
  <tr>
     <td width="8%" class="col_name1"><a href="#">โครงการ</a></td> 
...
<%
	  ...
	  sql.append("select a.comp_id, a.department, a.doc_date, a.orig_journal, a.t_doc_no, a.ref_no, a.doc_desc, a.chq_no, a.z_amount, a.bus_name ")
		    .append("from lan:acxgldtl a ")
			.append("where a.acct_no = '"+acctno+"' ");
	if (i_project.equals("ALL")) {
			sql.append("and not exists (select b.i_company, b.i_project from lan:serv_local b where a.comp_id = b.i_company and a.department = b.i_project) ")
			     .append("and a.department <> '099' ");    
	} else {
			 sql.append("and a.comp_id = '"+i_company+"' ")                                        
				 .append("and a.department = '"+i_project+"' ");        
	}		
if (month.equals("Q1")){  
	   sql.append("and month(a.doc_date) between '01' and '06' ");
} else if (month.equals("Q2")){
	   sql.append("and month(a.doc_date) between '07' and '12' ");
} else if (month.equals("ALL")){
	   sql.append("and month(a.doc_date) between '01' and '12' ");
} else {
	   sql.append("and month(a.doc_date) = '"+month+"' ");
}	
       sql.append("and year(a.doc_date) = '"+(Integer.parseInt(year)-543)+"' ")
	        .append("order by a.comp_id, a.department, a.doc_date, a.ref_no ");		 
...
%>
    <tr class="col_left ; specH1 ; white">
      <td class="col_center ; item"><%=doString.checkString(rs.getString("comp_id"))%>-<%=doString.checkString(rs.getString("department"))%></td>
     <td class="col_center"><%=doc_date%></td> 
...
<%
	...
	System.out.println("!!!ERROR EIS_AllPvdExpenceMonthDetail.jsp : " + e.getMessage());
	System.out.println("!!!ERROR EIS_AllPvdExpenceMonthDetail.jsp SQL : " + sql.toString());
