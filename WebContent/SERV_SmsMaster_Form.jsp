...
<HTML>
<HEAD>
<TITLE>ข้อมูลพื้นฐาน-เพิ่มรายการเบอร์ติดต่อแยกตามโครการ</TITLE>
      ...
      return ;
   	   ...
   	   ||firstdigit=='55'||firstdigit=='66'||firstdigit=='77'||firstdigit=='88'||firstdigit=='99'){
		   ...
		   return;
		    ...
		    document.forms[0].action="<%=request.getContextPath()%>/SERV_SmsMasterServlet?cmd=add";
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" class="BD" >
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          <td width="100%" class="bigh"><img border="0" src="images/i_home.gif" align="absmiddle" width="20" height="20">&nbsp;ข้อมูลพื้นฐาน-เพิ่ม</td>
        </tr>
      </table>
...
<br style="font-size:10pt">
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td class="item_tab2" width="250">เพิ่มรายการเบอร์ติดต่อแยกตามโครการ</td>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td height="22" width="82%" class="dotline01"><input type="text" name="mobileTxt" class="box" style="width:280px" value="" 
     maxlength="10" onkeypress="NumbericOnlyE(event);" ></td>
  </tr>
  <tr>
    <td class="item ; dotline01" height="22" width="18%">Fax :</td>
    <td height="22" width="82%" class="dotline01"><input type="text" name="faxTxt" class="box" style="width:280px" value="" ></td>
  </tr>
  <tr>
    <td class="item ; dotline01" height="22" width="18%">ชื่อเจ้าหน้าที่ผู้รับผิดชอบ :</td>
    <td height="22" width="82%" class="dotline01"><input type="text" name="serviceName" class="box" style="width:300px" value=""></td>
  </tr>
</table>
