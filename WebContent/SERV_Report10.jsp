...
String jName = "SERV_Report10.jsp";
...
try {
	...
	sql.append("select max(i_year) as max_y , max(i_month) as max_m  from serv_trfseq ");
...
/*	 if (document.forms[0].A_StartM.value=="") {
	...
	/* if (document.forms[0].sel_proj.options.length==0) {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_Report10_1.jsp";
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
 <tr>
    ...
    <td width="80%" class="dotline01">
		...
		<%=common.genYearListbox("A_StartY",A_StartY," class='box' ",minY,5)%>&nbsp;&nbsp; ถึง&nbsp;&nbsp;
