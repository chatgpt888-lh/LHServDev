...
%>
<%
String jName = "SERV_WageEdit.jsp";
...
<FORM NAME="frmSERV" METHOD=POST ACTION="SERV_WageEdit.jsp">
...
<td width="4%" class="col_name">
  <label>
  <input type="checkbox" name="chk_all" onclick="javascript:chkAll();">
  </label></td> 
...
%>
<tr>
<td class="dotline" align="center"><input type="checkbox" onclick="javascript:chgchk(this.checked);" name="chkDate" value="<%=DD%>/<%=M_MM1%>/<%=YY1%>"></td> 
...
%><OPTION value="<%=code%>"<%=temp%>><%=code%></OPTION>
<%    }// End For   	%></select></td>
<td class="dotline" align="center"><input name="comment<%=DD%>/<%=M_MM1%>/<%=YY1%>" type="text" value = "<%=i_comment%>" class="box" style="width:96%"></td>
...
%>
<tr>
<td class="dotline" align="center"><input type="checkbox" onclick="javascript:chgchk(this.checked);" name="chkDate" value="<%=DD1%>/<%=M_MM%>/<%=YY%>"></td> 
...
%><OPTION value="<%=code%>"<%=temp%>><%=code%></OPTION>
<%    }// End For   	%></select></td>
<td class="dotline" align="center"><input name="comment<%=DD1%>/<%=M_MM%>/<%=YY%>" type="text" value = "<%=i_comment%>" class="box" style="width:96%"></td>
...
<%
		...
		System.out.println("ERROR SERV_WageEdit.jsp : " + e.getMessage());
