...
String jName = "SERV_Zone_Conf_Full.jsp";
...
<!--
  ...
  function searchDocHD() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_Zone_Conf_Full.jsp";
...
<FORM METHOD="POST" ACTION="">
    ...
    <input type="hidden" name="success_page" value="SERV_Zone_Conf_Full.jsp?i_vendor=<%=iVendor%>">
    <input type="hidden" name="error_page" value="SERV_Zone_Conf_Full.jsp?error=1&i_vendor=<%=iVendor%>">
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <table border="0" width="140" cellspacing="0" cellpadding="0">
              <tr>
                <td width="100%" class="TextMenu"><a href="SERV_Zone_Conf.jsp?i_vendor=<%=iVendor%>"><img border="0" src="images/i_arrow1.gif" align="absmiddle" width="15" height="15">
                  แสดงแบบสรุป</a></td>
              </tr>
          </table>            
          </td>
                      ...
                      if (rs.next()) {
                         if (i>=startRow && i<=endRow) {
							...
							while (rs1.next()) {
							    ...
							    String fContr = doString.checkString(doString.DisplayThai(rs1.getString("f_contr")),"N");
...
<%
		...
		System.out.println("ERROR SERV_Zone_Conf_Full.jsp : " + e.getMessage());
