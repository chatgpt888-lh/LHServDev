...
<!--
  ...
  function searchDocHD() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_CONZone_Conf_Full.jsp";
...
<FORM METHOD="POST" ACTION="">
    ...
    <input type="hidden" name="success_page" value="SERV_CONZone_Conf_Full.jsp?itmType=<%=itmType%>&i_vendor=<%=iVendor%>">
    <input type="hidden" name="error_page" value="SERV_CONZone_Conf_Full.jsp?error=1&itmType=<%=itmType%>&i_vendor=<%=iVendor%>">    
      ...
      <td width="50%" class="bigh"><img border="0" src="images/i_home.gif" align="absmiddle" width="20" height="20">&nbsp; 
        Manager - ผู้จัดการกลุ่ม</td>
          ...
          <table border="0" width="140" cellspacing="0" cellpadding="0">
            ...
            <td width="100%" class="TextMenu"><a href="SERV_CONZone_Conf.jsp?itmType=<%=itmType%>&i_vendor=<%=iVendor%>"><img border="0" src="images/i_arrow1.gif" align="absmiddle" width="15" height="15"> 
              แสดงแบบสรุป</a></td>
              </tr>
          </table>    
			</td>
...
<%
      ...
      <td class="textgray">&nbsp;&nbsp; เลขที่ใบเบิกงวด 
          ...
          <tr>             <td class="col_nameS" rowspan="2" width="48%"><%=nJob%></td>            <td rowspan="2" class="col_nameS">งวดที่</td>            <td colspan="3"  class="col_nameS">ค่าแรง</td>            <td colspan="3"  class="col_nameS">ค่าของ</td>            <td rowspan="2" class="col_nameS" width="7%">ค่าแรง<br>+ ค่าของ</td>            <td rowspan="2" class="col_nameS" width="7%">รวมค่า<br>ดำเนินการ</td>          </tr>          <tr>             <td class="col_nameLow" width="3%">จำนวน</td>            <td class="col_nameLow" width="7%">ต่อหน่วย</td>            <td class="col_nameLow" width="7%">รวม</td>
            ...
            <td class="dotline" align="right" width="7%" valign="top"><%=format.format(sumTotal)%></td>            <td class="dotline" align="right" width="7%" valign="top"><%=format.format(cutVendor)%></td>
							  ...
							  if (remark.length()>0) {
								  %>      
          <tr>
            <td class="dotline" width="48%" valign="top"><img border="0" src="images/bu_nextPage.gif" align="absmiddle" width="5" height="7">&nbsp;               <font color="#FF6699"><%=remark%></font></td>            <td class="dotline" align="center" width="4%" valign="top">&nbsp;</td>
      ...
      <td class="textgray">&nbsp;</td>                
          ...
          <tr>             <td class="col_nameLow" width="3%">จำนวน</td>            <td class="col_nameLow" width="7%">ต่อหน่วย</td>            <td class="col_nameLow" width="7%">รวม</td>
            <td class="col_nameLow" width="3%">จำนวน</td>            <td class="col_nameLow" width="7%">ต่อหน่วย</td>            <td class="col_nameLow" width="7%">รวม</td>          </tr>								        <%								        for (int l=0;l<5;l++) {								        %>
          <tr> 
            <td class="dotline" width="48%" valign="top">&nbsp;</td>            <td class="dotline" align="center" width="4%" valign="top">&nbsp;</td>
            <td class="dotline" align="right" width="3%" valign="top">&nbsp;</td>            <td class="dotline" align="right" width="7%" valign="top">&nbsp;</td>            <td class="dotline" align="right" width="7%" valign="top">&nbsp;</td>
            <td class="dotline" align="right" width="3%" valign="top">&nbsp;</td>            <td class="dotline" align="right" width="7%" valign="top">&nbsp;</td>            <td class="dotline" align="right" width="7%" valign="top">&nbsp;</td>
            <td class="dotline" align="right" width="7%" valign="top">&nbsp;</td>            <td class="dotline" align="right" width="7%" valign="top">&nbsp;</td>          </tr>								        <%								        } // end for								        %>
        </table>							    </td>							  </tr>							</table>							<table border="0" width="100%" cellspacing="0" cellpadding="0">							  <tr>							    <td width="5" valign="bottom"><img border="0" src="images/Corn03.gif" width="5" height="5"></td>							    <td class="frmBottom">&nbsp;</td>							    <td width="5" valign="bottom" align="right"><img border="0" src="images/Corn04.gif" width="5" height="5"></td>							  </tr>					  							</table>
...
<br style="font-size:10pt">
      ...
      <td class="act_tab4"><a href="SERV_CONZone_Conf.jsp?itmType=<%=itmType%>" target="_self"><img border="0" src="images/bu_back.gif" align="absmiddle" width="50" height="15"></a>&nbsp; 
...
<%
		...
		System.out.println("ERROR SERV_CONZone_Conf_Full.jsp : " + e.getMessage());
