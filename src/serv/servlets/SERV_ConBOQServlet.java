 ...
 * @author
 */
public class SERV_ConBOQServlet extends DBServlet  {
	...
	public void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		String successPage = "SERV_ConBOQ01.jsp";
		String errorPage = "SERV_ConBOQ02.jsp?i_group="+iGroup+"&i_type="+iType+"&i_seq="+iSeq+"&i_itmjob="+iItm+"&mode="+mode;
		...
		ResultSet rs = null;
		 ...
		 try {
			...
			//----======== Delete Mode , Insert Query =========----//
				 ...
				 successPage = Constants.APP_PATH+"/SERV_ConBOQ01.jsp";	 
				 savePage = Constants.APP_PATH+"/SERV_ConBOQ01.jsp";	 
	 			 errorPage = Constants.APP_PATH+"/SERV_ConBOQ01.jsp&error=1";	
	 			 otherMsg="";
