 ...
 * date time: 2015.02.26
 * Last modify :
 * version :1.0
 * project Name : Report  หน้าสรุปการแจ้งซ่อมผ่าน E-sv แยกเป็น Zone 
 * description :  หน้าสรุปการแจ้งซ่อมผ่าน E-sv แยกเป็น Zone 
***************************************************/
--%>
<%!
...
<HTML>
<HEAD>
<TITLE>Report สรุปการแจ้งซ่อมผ่าน e-Service แยกตาม Zone</TITLE>
...
function doSubmit(){
    ...
    var checkRbt = getCheckedValue(obj);
	 ...
	 if(isAll){//เลือกโครงการเท่ากับ ทุกโครงการ
	 	...
	 	do_totals1() ;
		document.forms[0].action="<%=request.getContextPath()%>/SERV_ReportInformRepairServlet?cmd=GenReport";
    ...
    <td width="100%" class="BD" >   
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          ...
          &nbsp;Report สรุปการแจ้งซ่อมผ่าน e-Service แยกตาม Zone</td>
        </tr>
      </table>
