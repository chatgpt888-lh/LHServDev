					...
					<tr>
						...
						<table border="0" width="100%" cellspacing="0" cellpadding="0">
							<tr>
								...
								<a href="SERV_ViewTimeLst.jsp?seq=<%=seq-7%>"><< ย้อมกลับ</a>
								</td>
								<td class="dotline01" height="22" width="50%" align="right">
								<a href="SERV_ViewTimeLst.jsp?seq=<%=seq+7%>">ถัดไป >></a>
								</td>
							</tr>
						</table>
						</td>
					...
					<tr>
						...
						<table border="0" width="100%" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td height="22" colspan="7" class="col_name02">วัน/เวลาที่จองได้</td>
							</tr>
							<tr>
										...
										if (!cTime.isReserve()) {
											if (i < 31) {
												if (cTime.getChkDate().equals(strDay[i]) && cTime.getChkTime().equals(brTime)) {
													out.print("<img src=\"images/i_pass.gif\" width=\"19\" height=\"16\">");											
													break;
												}
											}
										}
...
<%
		...
		System.out.println("ERROR SERV_ViewTimeLst.jsp : " + e.getMessage());
