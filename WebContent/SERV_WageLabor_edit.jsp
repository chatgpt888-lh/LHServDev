...
%>
    ...
    <td class="dotlineREP ; item"><%=doString.checkString(doString.DisplayThai(rs.getString("i_name")))%>&nbsp;</td>
...
%>    
	...
	<td class="dotlineREP" align="center"><img src="<%=img%>" align="absmiddle" border="0"></td>
