...
String groupName = request.getAttribute("groupName")==null?"": (String)request.getAttribute("groupName");
String subName = request.getAttribute("subName")==null?"": (String)request.getAttribute("subName");
String itemsName = request.getAttribute("itemsName")==null?"": (String)request.getAttribute("itemsName");
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="item ; dotline01" height="22" colspan="4">หมวดหลัก : <%=groupName %>
    </td>
  </tr>
  <tr>
    <td class="item ; dotline01" height="22" colspan="4">หมวดรอง : <%=subName %>
    </td>
  </tr>	
  <tr>
    <td class="item ; dotline01" height="22" colspan="4">หมวดย่อย : <%=itemsName %>
    </td>
  </tr>
</table>
    ...
    <td width="100%" class="frmL">
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="3%" class="col_name">รายการ</td>
          <td width="10%" class="col_name">โครงการ</td>
          <td width="5%" class="col_name">แปลง</td> 
          <td width="5%" class="col_name">วันที่โอน</td>
          <td width="5%" class="col_name">End Product</td>
          <td width="3%" class="col_name">Diff</td>
          <td width="13%" class="col_name">ผู้รับเหมา</td>
          <td width="8%" class="col_name">วันที่ Key</td>
          <td width="7%" class="col_name">เลขที่ใบเบิก</td>
          <td width="2%" class="col_name"><font color="#ff7537">*</font>ประเภท</td>
          <td width="7%" class="col_name">จำนวนเงิน</td>
          <td width="7%" class="col_name">วันที่จ่าย</td>
          <td width="7%" class="col_name">หมายเหตุ</td>
          <td width="4%" class="col_name"><font color="#ff7537">*</font>ตรวจบ้าน</td>
          <td width="6%" class="col_name">บ.รับตรวจบ้าน</td>
        ...
        if(listIpvQCHD!=null && listIpvQCHD.size()>0){
	        ...
	        while(itHD.hasNext()){
			 ...
			 fqa_type = strList.get(19).toString();
        	 qaNameVendor = strList.get(20).toString();
      ...
      %>        
		        <tr height="25px" bgcolor="<%=tagColor %>">
		          <td class="dotline ; item" align="center"><%=x++  %></td>
		          ...
		          <td align="center" class="dotline"><%=strList.get(3).toString()%></td><!-- D_CloseLaw -->  
		          <td align="center" class="dotline"><%=strList.get(17).toString()%></td><!-- DateQC --> 
		          <td align="center" class="dotline"><%=strList.get(18).toString()%></td><!-- DiffDay -->   
		          ...
		          <td  align="center" class="dotline"><%=strList.get(7).toString() %>&nbsp;</td>
		          <td  align="right"  class="dotline">
		          <%
		          if(Double.parseDouble(strList.get(15).toString())==0){
		              out.println("0");
		          }else{
		             out.println(format1.format(Double.parseDouble(strList.get(15).toString())));
		          } %>&nbsp;
		          </td>
		          <td  align="center"  class="dotline"><%=strList.get(16).toString()%>&nbsp;</td>
		...
		<%     //loop++;
	       ...
	       loopX = loop;
        	...
        	%>
				<tr align="left" > 
                       <td  height="22"  align="center" colspan="16" class="side01" >***ไม่มีข้อมูล***</td>
                </tr>
       <% 	
        }
		%>        	        		                                                          
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr >
          <td class="item ; dotline01" width="10%" align="right">&nbsp;</td>
          <td class="item ; dotline01" width="15%" align="left"><b>Column ประเภท</b></td>
          <td class="item ; dotline01" width="75%" align="left"><b>ประเภทการตรวจบ้าน</b></td>
        </tr>
        <tr >
          <td class="item ; dotline01" width="10%" align="right">1:</td>
          <td class="item ; dotline01" width="15%" align="left">จากระบบ Billing</td>
          <td class="item ; dotline01" width="75%" align="left">1 :&nbsp;ลูกค้าตรวจเอง</td>
        </tr>
        <tr >
          <td class="item ; dotline01" width="10%" align="right">2:</td>
          <td class="item ; dotline01" width="15%" align="left">จากระบบ PR</td>
           <td class="item ; dotline01" width="75%" align="left">2 :&nbsp;บริษัทรับตรวจบ้าน</td>
        </tr>
        <tr >
          <td class="item ; dotline01" width="10%" align="right">3:</td>
          <td class="item ; dotline01" width="15%" align="left">มีรายการยอดจ่ายเท่ากับ 0</td>
           <td class="item ; dotline01" width="75%" align="left">&nbsp;</td>
        </tr>
        <tr >
          <td class="item ; dotline01" width="10%" align="right">4:</td>
          <td class="item ; dotline01" width="15%" align="left">ไม่มีรายการ</td>
           <td class="item ; dotline01" width="75%" align="left">&nbsp;</td>
        </tr>
 </table>
