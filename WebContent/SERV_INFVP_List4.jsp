...
<!--
  function searchDocHD() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_INFVP_List4.jsp";
...
<FORM METHOD="POST" ACTION="">
    ...
    <input type="hidden" name="success_page" value="SERV_INFVP_List4.jsp?itmType=<%=itmType%>">
    <input type="hidden" name="error_page" value="SERV_INFVP_List4.jsp?error=1&itmType=<%=itmType%>">
      ...
      <td width="50%" class="bigh"><img border="0" src="images/i_home.gif" align="absmiddle" width="20" height="20">&nbsp; 
        Manager - ผู้จัดการกลุ่ม</td>
          ...
          <table border="0" width="140" cellspacing="0" cellpadding="0">
            ...
            <td width="100%" class="TextMenu"><a href="SERV_INFVP_List3.jsp?itmType=<%=itmType%>&sel_project=<%=selProj%>&d_payment=<%=dPayment%>"><img border="0" src="images/i_arrow1.gif" align="absmiddle" width="15" height="15"> 
              แสดงแบบสรุป</a></td>
              </tr>
          </table>    
			</td>
...
<%
      ...
      <td class="textgray"><%=nProject%>&nbsp;&nbsp; เลขที่ใบสั่งซ่อม 
...
<%
		...
		stmt1=null;
		conn=null;
		System.out.println("---- SERV_INFVP_List4.jsp ----- ");
	} catch (Exception e) {
		System.out.println("ERROR SERV_INFVP_List4.jsp : " + e.getMessage());
