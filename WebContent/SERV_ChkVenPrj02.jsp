...
System.out.println("end set session");	       				
   	}//end addCart =='Yes'
...
<script language="javascript">
  ...
  function searchData(){
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_ChkVenPrj02.jsp?mode=search";
   ...
   function checkOut() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_ChkVenPrj02.jsp?i_type=<%=iType%>";
     document.forms[0].submit();
  } 
 ...
 function addToCart() { 
  ...
  function changePage(page) {  
    ...
    document.forms[0].action="<%=Constants.APP_PATH%>/SERV_ChkVenPrj02.jsp";
    document.forms[0].submit();
  }    
...
<%
		...
		System.out.println("ERROR SERV_ChkVenProj02.jsp : " + e.getMessage());
