 ...
 * @author
 */
public class PrintInfLetter3Servlet extends DBServlet  {
	...
	public void printLetter(Document document, String printDate, String inf_year, String projNme, String custName, String houseId,float price,String startDate,String endDate,double amount) throws Exception {
	  ...
	  table.addCell(addCellData("ฉบับที่ 4","R","C","",100,microssfont));
	  ...
	  table.addCell(addCellData("ขอความร่วมมือในการชำระค่าบริการสาธารณะ (ครั้งที่ 1)","L","C","",95-3,microssfont));
	  ...
	  table.addCell(addCellData(" ","L","C","",5+3,microssfont));
	  table.addCell(addCellData("ตามที่ บริษัท แลนด์ แอนด์ เฮ้าส์ จำกัด (มหาชน) ได้ดำเนินการจัดเก็บค่าบริการสาธารณะเพื่อให้การบริการ","L","C","",95-3,microssfont));
	  
	  table.addCell(addCellData("เป็นไปอย่างต่อเนื่องในอัตราตารางวาละ "+doString.displayNumber("###.00", price)+" บาท/เดือน โดยมีการจัดเก็บล่วงหน้าเป็นระยะเวลาคราวละ 1 ปี","L","C","",100,microssfont));
	  table.addCell(addCellData("งวดเดือน "+startMnth+" พ.ศ. "+startYear+" ถึงเดือน "+endMnth+" พ.ศ. "+endYear,"L","C","",100,microssfont));
	  
	  table.addCell(addCellData(" ","L","C","",5+3,microssfont));
	  table.addCell(addCellData("ทั้งนี้ในปัจจุบันท่านยังคงค้างชำระค่าบริการสาธารณะประจำปี "+inf_year+" ตั้งแต่เดือน "+startMnth+" พ.ศ. "+startYear+" จนถึงเดือน","L","C","",95-3,microssfont));
	  table.addCell(addCellData(endMnth+" พ.ศ. "+endYear+" เป็นจำนวนเงิน "+doString.displayNumber("###,###,###.00", amount)+" บาท ("+doString.MS874ToUnicode(currencyToThai.getString())+")","L","C","",100,microssfont));
	  
	  table.addCell(addCellData(" ","L","C","",5+3,microssfont));
	  table.addCell(addCellData("ดังนั้นบริษัทฯ จึงใคร่ขอความร่วมมือจากท่านได้โปรดชำระเงินดังกล่าว เพื่อที่บริษัทฯ จะได้นำเงินดังกล่าวไป","L","C","",95-3,microssfont));
	  table.addCell(addCellData("เป็นค่าใช้จ่ายในการบำรุงดูแลการบริการสาธารณะต่างๆ ภายในโครงการต่อไป","L","C","",100,microssfont));
	  table.addCell(addCellData(" ","L","C","",5+3,microssfont));
	  table.addCell(addCellData("โดยขอให้ท่านชำระค่าบริการฯให้แล้วเสร็จภายใน 7 วันนับจากวันที่ท่านได้รับหนังสือฉบับนี้","L","C","",95-3,microssfont_BOLD));
	  
	  table.addCell(addCellData(" ","L","C","",100,microssfont));
	  
	  table.addCell(addCellData(" ","L","C","",5+3,microssfont));
	  table.addCell(addCellData("จึงเรียนมาเพื่อทราบและโปรดดำเนินการภายในระยะเวลาที่กำหนดดังกล่าวด้วย และหากท่านได้ชำระเงิน","L","C","",95-3,microssfont));
	  table.addCell(addCellData("ค่าบริการสาธารณะไปก่อนที่จะได้รับหนังสือฉบับนี้ บริษัทฯ ต้องกราบขออภัยมา ณ โอกาสนี้","L","C","",100,microssfont));
...
*/			
		  ...
		  conn = null;
			 ...
			 System.err.println("error PrintInfLetter3Servlet  DOCUMENT: " + de.getMessage());
		} catch (Exception e) {
