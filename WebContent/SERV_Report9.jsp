...
<!--
  ...
  function searchDocHD() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_Report9.jsp?search=y";
				   ...
				   //---=========================================================================----//      
						...
						<%
					            ...
					            <table border="0" width="100%" cellspacing="0" cellpadding="0">
					              <tr>
					                ...
					                <td class="textgray"><%=nProject%>&nbsp;&nbsp;
					                  เลขที่ใบแจ้งซ่อม :
					                  <a href="SERV_OpenJob_Pay_Disp.jsp?i_docno=<%=docNo%>&popup=y&edit=no" target="_blank"><%=docNo%></a>&nbsp;
								    ...
								    <td width="100%" class="frmL">
								      ...
								      <table border="0" width="100%" cellspacing="0" cellpadding="0">
								        <tr>
								          ...
								          <td rowspan="2" class="col_nameS" width="3%">การตัด<br>
							...
							while (rs1.next()) {
							    ...
							    String fContr = doString.checkString(doString.DisplayThai(rs1.getString("f_contr")),"");
					        ...
					        %>
							        <tr>
							          ...
							          <td class="dotline" align="right" width="3%" valign="top"><%=fContr%></td>
...
<%
		...
		System.out.println("ERROR SERV_Report9.jsp : " + e.getMessage());
