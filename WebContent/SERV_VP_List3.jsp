...
String jName = "SERV_VP_List3.jsp";
	...
	//---==============================================================================----//
	   ...
	   //---=========================================================================----//      
        ...
        sql.append(" select count(*) from serv_payment b,serv_dochd a where ")
              ...
              .append(" and b.f_itmstatus='800' ").append(condition)                   
...
<!--
  ...
  function searchDocHD() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_VP_List3.jsp";
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <table border="0" width="140" cellspacing="0" cellpadding="0">
              <tr>
                <td width="100%" class="TextMenu"><a href="SERV_VP_List4.jsp?sel_project=<%=selProj%>&d_payment=<%=dPayment%>"><img border="0" src="images/i_arrow1.gif" align="absmiddle" width="15" height="15">
		        ...
		        for (int i=0;i<maxRow;i++) { 
                      if (rs.next()) {
                         if (i>=startRow && i<endRow) {
							...
							//---============ Find Vendor Cut ==============---//
							sql.delete(0,sql.length());
							sql.append(" select b.i_docno,p_cut,sum(z_cut_pv) sum_cut_pv from lan:serv_dochd a,lan:serv_payment b ")
