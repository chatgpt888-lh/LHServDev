...
String jName = "SERV_ConBOQ01.jsp";
ServLog servlog = new ServLog(sessionId, userId, jName);
	...
	String flag = doString.checkString(request.getParameter("flag"),"C");
	...
	try {
       ...
       //-----========== Query for search by ID ===============-----//
	       ...
	       if (iType.equalsIgnoreCase("ALL")) {
			  ...
			  condition += " and a.i_seq[1,1] = '"+flag+"' ";  //= C
...
function deleteData() {
    if (confirm("คุณต้องการลบข้อมูลที่ทำการเลือกทั้งหมดนี้ ?")) {
       document.forms[0].action = "<%=Constants.APP_PATH%>/SERV_ConBOQServlet?mode=delete&i_itmjob=<%=iItm%>"; 
       document.forms[0].submit();
    } 
}

function searchBOQ(){
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_ConBOQ01.jsp";
     document.forms[0].submit();  
  }
          ...
          <td class="col_name" width="12%">หน่วยนับ</td>
           ...
           <%
		     ...
		     <tr height="25px">
				...
				<td class="dotline" width="12%"><a href="SERV_ConBOQ02.jsp?mode=edit&i_itmjob=<%=iItm%>"><%=nItm%></a></td>
...
<br style="font-size:10pt">
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" height="30">
          <tr>
            ...
            <a href="SERV_ConBOQ02.jsp?mode=add&flag=<%=flag%>"><img border="0" src="images/act_add.gif"                                   
...
<%
		...
		System.out.println("ERROR SERV_ConBOQ01.jsp : " + e.getMessage());
