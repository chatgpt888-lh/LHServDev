...
<%
   ...
   if  (selProj.length()==0) {
	...
	try {
		...
		sql.append(" select n_project from lan:acxprojt where i_company='"+(selProj.length()>=6 ? selProj.substring(0,2) : "")+"' and i_project='"+(selProj.length()>=6 ? selProj.substring(3,6) : "")+"' ");
	   ...
	   //---=========================================================================----//   
        ...
        //----====================== Get INFDOCHD Max Row ==============================-----//
        int maxRow = 0;
		sql.delete(0,sql.length());
		sql.append(" select count(*) from lan:serv_infpayment b,serv_infdochd a where b.f_itmstatus = 'CLS' ")
			 .append(condition)
...
<HTML>
<HEAD>
<TITLE>ใบเบิกงวดงาน - อนุมัติแล้ว</TITLE>
...
<!--
  ...
  function searchDocHD() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_CONPass_Full.jsp";
...
<FORM METHOD="POST" ACTION="">
    ...
    <input type="hidden" name="success_page" value="SERV_CONPass_List.jsp?itmType=<%=itmType%>">
    <input type="hidden" name="error_page" value="SERV_CONPass_Full.jsp?error=1&itmType=<%=itmType%>">
      ...
      <td width="50%" class="bigh"><img border="0" src="images/i_home.gif" align="absmiddle" width="20" height="20">&nbsp; 
        ใบเบิกงวดงาน - อนุมัติแล้ว</td>
          <td width="50%" align="right">
          <table border="0" width="140" cellspacing="0" cellpadding="0">
              <tr>
                
            <td width="100%" class="TextMenu"><a href="SERV_CONPass_List.jsp?itmType=<%=itmType%>&sel_project=<%=selProj%>&d_payment=<%=dPayment%>"><img border="0" src="images/i_arrow1.gif" align="absmiddle" width="15" height="15"> 
              แสดงแบบสรุป</a></td>
              </tr>
          </table>    
			</td>
...
<%
      ...
      <td class="textgray"><%=projectName%>&nbsp;&nbsp; เลขที่ใบเบิกงวด 
...
<br style="font-size:10pt">
      ...
      <td class="act_tab4"><a href="SERV_CONPass_List.jsp?itmType=<%=itmType%>" target="_self"><img border="0" src="images/bu_back.gif" align="absmiddle" width="50" height="15"></a>&nbsp; 
...
<%
		...
		System.out.println("ERROR SERV_CONPass_Full.jsp : " + e.getMessage());
