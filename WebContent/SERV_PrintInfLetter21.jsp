...
<!--
  function PrintLetter(frm) {
	 frm.target = "_blank";
	 frm.action = "https://www7.lh.co.th/LHServ/PrintInfLetter21Servlet";
	 //frm.action = "/LHServ/PrintInfLetter21Servlet";
     frm.submit();
	 frm.target = "_self";
  }
  function ChangeYear(frm) {
	 frm.action = "/LHServ/SERV_PrintInfLetter21.jsp";
     frm.submit();
  }
...
<FORM NAME="frmLetter" METHOD=POST ACTION="SERV_PrintInfLetter21.jsp">
...
%>
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td class="item_tab2" width="250">จดหมายแจ้งกำหนดการเริ่มจัดเก็บค่าบริการสาธารณะ</td>
...
%> 
					...
					<tr>					
                  <td class="item ; dotline01" height="22" width="20%">ช่วงวันที่ตั้งแต่
                    :</td>
                  <td height="22" class="dotline01" width="80%"><%date_util.printHtmlThaiDateNoTime(out, "Beg", beg_date, 5, 2, "white", "#0078FF");%> ถึง <%date_util.printHtmlThaiDateNoTime(out, "End", end_date, 5, 2, "white", "#0078FF");%></td>
					</tr>
					<tr>
					<tr>					
                  <td class="item ; dotline01" height="22" width="20%">ชำระภายในวันที่่
                    :</td>
                  <td height="22" class="dotline01" width="80%"><%date_util.printHtmlThaiDateNoTime(out, "In", "", 5, 2, "white", "#0078FF");%></td>
					</tr>
                  ...
                  <td height="22" class="dotline01" width="80%"><%date_util.printHtmlThaiDateNoTime(out, "Prnt", "", 5, 2, "white", "#0078FF");%></td>
					...
					<tr>					
                  <td class="item ; dotline01" height="22" width="20%">วันที่่สิ้นสุดระยะเวลาการให้บริการ
                    :</td>
                  <td height="22" class="dotline01" width="80%"><%date_util.printHtmlThaiDateNoTime(out, "Finish", "", 5, 2, "white", "#0078FF");%></td>
					</tr>
					<tr>
...
<%
		...
		System.out.println("ERROR SERV_PrintInfLetter21.jsp : " + e.getMessage());
