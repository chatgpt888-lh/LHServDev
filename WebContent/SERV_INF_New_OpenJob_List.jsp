...
<!--
  ...
  function changePage(page) {
     ...
     document.forms[0].action="/LHServ/SERV_INF_New_OpenJob_List.jsp";
     document.forms[0].submit();
  }
...
<FORM NAME="frmNewJob" METHOD=POST ACTION="/LHServ/SERV_INF_New_OpenJob_List.jsp">
...
<br style="font-size:10pt">
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td class="item_tab2" width="200">รายละเอียดการสั่งซ่อมสาธารณูฯ</td>
...
<%
	...
	sql.append("SELECT COUNT(DISTINCT h.i_docno) AS NUM_DOC ")
		...
		.append(doc_restrict)
		.append(" AND a.i_docno = h.i_docno")
...
%>
                <tr>
                  <td width="11%" align="center" class="dotline"><a href="<%=targetPage%>?docNo=<%=docNo%>"><%=docNo%></a></td>
...
<%
		...
		System.out.println("ERROR SERV_INF_New_OpenJob_List.jsp : " + e.getMessage());
