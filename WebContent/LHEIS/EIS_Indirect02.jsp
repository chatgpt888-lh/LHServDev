...
try {
	...
	String typecost = "";  // set default
	if (request.getParameter("typecost") != null) {
		typecost = doString.checkString(request.getParameter("typecost"));
	}
	String option = "", type_id = "", sum_detail = "", sum_all = "", n_proj = "", com_id = "", proj_id = "", tb_name = "", grp = "";
	...
	double all2_m1 = 0, all2_m2 = 0, all2_m3 = 0, all2_m4 = 0, all2_m5 = 0;
	double all2_m6 = 0, all2_m7 = 0, all2_m8 = 0, all2_m9 = 0, all2_m10 = 0;
	double all2_m11 = 0, all2_m12 = 0, all2_m13 = 0, all2_sm1 = 0, all2_sm2 = 0;
	double tot_per = 0, z_per1 = 0, z_per2 = 0, z_net_ytd = 0;


%>
<FORM NAME="frmEIS" METHOD=POST ACTION="EIS_Indirect02.jsp">
...
<input type="radio" value="V3" name="type" <% if (type.equals("V3")) { out.print("checked"); }%>>&nbsp;ค่าใช้จ่าย+ต้นทุนทางอ้อม&nbsp;&nbsp;&nbsp;&nbsp;<A HREF="javascript:frmEIS.submit();"><img border="0" src="images/bu_go.gif" align="absmiddle" width="40" height="22"></A></td>
  ...
  <tr>
    ...
    <tr class="specH1">
      ...
      <td width="20%" class="col_left ; item"><img border="0" src="images/i_arrow1.gif" align="absmiddle" width="15" height="15">&nbsp;โครงการปิด</td>
      <td width="5%"></td>
      <td width="5%"></td>
      <td width="5%"></td>
      <td width="5%"></td>
...
// ------------------------------------ Close Project ---------------------------------------
	   ...
	   sql.append("select i_company, i_project from lan:vw_project a ")  // select view  vw_project  
			...
			.append("and not exists (select b.i_company, b.i_project from lan:acbhlprj b ")
...
%>
								  ...
								  <td width="22%" class="col_left ; Lmar2"><%=com_id+"-"+proj_id%>&nbsp;<%=n_proj%></td>
								  <td width="5%"></td>
								  <td width="5%"></td>
								  <td width="5%"></td>
								  <td width="5%"></td>
								...
								<tr class="col_right ; specH1 ; white">
								  <td width="22%" class="col_left ; Lmar2">- <a href="EIS_ExpenceMonth.jsp?i_com=<%=doString.checkString(rs1.getString("i_company"))%>&i_proj=<%=doString.checkString(rs1.getString("i_project"))%>&typecost=<%=typecost%>&type=V1&year=<%=year%>"> ค่าใช้จ่าย</a></td>
								  ...
								  <td width="2%"><%=doString.displayNumber("###,###.0", z_per1)%></td>
								</tr>
<%							//  --------------   TOTAL  V1 -----------------										
									tot_m1 += r1_m1;
									tot_m2 += r1_m2;
...
%>
									...
									<tr class="col_right ; specH1 ; white">
									  <td width="22%" class="col_left ; Lmar2">- <a href="EIS_ExpenceMonth.jsp?i_com=<%=doString.checkString(rs2.getString("i_company"))%>&i_proj=<%=doString.checkString(rs2.getString("i_project"))%>&typecost=<%=typecost%>&type=V2&year=<%=year%>"> ต้นทุนทางอ้อม</a></td>
									  ...
									  <td width="2%"><%=doString.displayNumber("###,###.0", z_per2)%></td>
									</tr>
<%						//  --------------   TOTAL  V2 -----------------										
									tot_m1 += r2_m1;
									tot_m2 += r2_m2;
...
%>    
    <tr class="specH1">
      <td width="22%" class="col_name1">รวม Site ปิด</td>
      ...
      <td width="2%" class="col_name1r"><%=doString.displayNumber("###,###.0", (tot_m13 / tot_per) * 100)%></td>
    </tr>    
  </table>           
...
<%
	...
	System.out.println("!!!ERROR EIS_Indirect02.jsp : " + e.getMessage());
	System.out.println("!!!ERROR EIS_Indirect02.jsp SQL : " + sql.toString());
