...
%>
<FORM NAME="frmEIS" METHOD=POST ACTION="EIS_PvdExpenceMonthDetail.jsp">
...
<%
	...
	if (!i_project.equals("ALL")) {
			sql.append("and comp_id = '"+i_company+"' ")                                                                
...
<%
	...
	System.out.println("!!!ERROR EIS_PvdExpenceMonthDetail.jsp : " + e.getMessage());
	System.out.println("!!!ERROR EIS_PvdExpenceMonthDetail.jsp SQL : " + sql.toString());
