...
String jName = "SERV_FCReport.jsp";
...
function submit()  {		
		Finger.action = "/LHServ/SERV_FCReport.jsp";
		Finger.submit();
}
...
<FORM NAME="Finger" METHOD="POST" ACTION="SERV_FCReport.jsp">
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          <td width="50%" class="bigh"><img border="0" src="images/i_home.gif" align="absmiddle" width="20" height="20">&nbsp;
            รายงานสรุปการเข้างานของช่างแต่ละโครงการ</td>
    ...
    <td width="100%" class="frmL">
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="10%" class="col_name">รหัส</td>
          <td width="15%" class="col_name"><A HREF="javascript:OrderBy('a.i_name');">ชื่อ-สกุล</A></td>
          <td width="15%" class="col_name"><A HREF="javascript:OrderBy('a.i_header');">โครงการ</A></td>
		  ...
		  <td width="10%" class="col_name">ค่าแรง</td>
        </tr>
...
//out.println("subcondition =="+subcondition);
		     ...
		     //----================== Select Data from SERV_DOCHD ================----//   
				...
				String i_date = "", i_checkin = "", i_checkout = "";		
					...
					String h_proj = "";
					sql.delete(0,sql.length());	
					sql.append("select distinct a.i_cardno, a.i_name, a.i_header, a.i_date, a.i_checkin, a.i_checkout, b.n_job, b.z_wage ")
						 .append("from lan:serv_finger a, lan:serv_tstaff b ")
						 .append("where a.i_cardno = b.i_cardno ")                 
						 .append("and a.i_header != 'Admin Dept' ")
						 .append(condition);
					 ...
					 if (!i_checkin.equals("-")) {						
					  ...
					  if (!i_date.equals("-")) {						
							i_date = i_date.substring(8,10)+"/"+i_date.substring(5,7)+"/"+i_date.substring(0,4);							
								 ...
								 n_proj = "";
								 sql.delete(0, sql.length());
								 sql.append("SELECT DISTINCT b.n_project ")
									  .append("from lan:serv_finger a, lan:acxprojt b ")
									  .append("where a.i_header = '"+doString.checkString(rs.getString("i_header"))+"' ")
									  .append("and a.i_header[1,2] = b.i_company ")
									  .append("and a.i_header[3,5] = b.i_project ");					
								rs1 = stmt1.executeQuery(sql.toString());
								if (rs1.next()==true) {
										n_proj = doString.checkString(doString.DisplayThai(rs1.getString("n_project")),"-");
								}

%>
					        <tr>
					          <td width="5%" align="center" class="dotline"><%=line%></td>
					          <td width="10%" class="dotline ; item" align="center"><%=doString.checkString(rs.getString("i_cardno"),"-")%></td>
					          <td width="15%" class="dotline" align="left">&nbsp;<%=doString.checkString(doString.DisplayThai(rs.getString("i_name")),"-")%></td>
					          <td width="15%" align="left" class="dotline">&nbsp;<%=doString.checkString(rs.getString("i_header"),"-")%>&nbsp;&nbsp;<%=n_proj%></td>
					          ...
					          <td width="15%" align="center" class="dotline"><%=doString.checkString(doString.DisplayThai(rs.getString("n_job")),"-")%></td>
							   <td width="10%" align="right" class="dotline"><%=rs.getDouble("z_wage")%>&nbsp;</td>
					        </tr>			
...
%>
							...
							<tr>
					          ...
					          <td width="10%" class="dotline ; item" align="center">&nbsp;</td>
					          <td width="15%" class="dotline" align="left">&nbsp;</td>
					          ...
					          <td width="15%" align="right" class="dotline ; item">Total&nbsp;</td>
							   <td width="10%" align="right" class="dotline ; item"><%=sum_wage%>&nbsp;</td>
					        </tr>
<%
...
%>    							
							<tr>
					          <td width="100%" align="center" class="dotline" colspan=9>....................   ไม่มีรายการ   ....................</td>
							</tr>							
...
<%
		...
		System.out.println("ERROR SERV_FCReport.jsp : " + e.getMessage());
