...
String jName = "SERV_VP_List4.jsp";
   ...
   if  (selProj.length()==0) {
	...
	try {
	   ...
	   //---=========================================================================----//   
        ...
        //----====================== Get DOCHD Max Row ==============================-----//
         String f_itmstatus = "800"; //default 800
         
        int maxRow = 0;
		sql.delete(0,sql.length());
		sql.append(" select count(*) from serv_payment b,serv_dochd a where b.f_itmstatus='"+f_itmstatus+"' ")
...
<!--
  ...
  function searchDocHD() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_VP_List4.jsp";
...
<FORM METHOD="POST" ACTION="">
    ...
    <input type="hidden" name="success_page" value="SERV_VP_List4.jsp">
    <input type="hidden" name="error_page" value="SERV_VP_List4.jsp?error=1">
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <table border="0" width="140" cellspacing="0" cellpadding="0">
              <tr>
                <td width="100%" class="TextMenu"><a href="SERV_VP_List3.jsp?sel_project=<%=selProj%>&d_payment=<%=dPayment%>"><img border="0" src="images/i_arrow1.gif" align="absmiddle" width="15" height="15">
                  แสดงแบบสรุป</a></td>
              </tr>
          </table>            
          </td>
...
<%
		     //----================== Select Data from SERV_DOCHD ================----//   
		        ...
		        sql.append(" select first ").append(endRow).append(" a.i_docno,a.i_lock,c.n_project,a.i_type_cutlck ")
		              ...
		              .append(" and b.f_itmstatus='"+f_itmstatus+"' ")
		              //.append(" and b.i_vendor='").append(iVendor).append("' ")
		              //.append(" and substr(b.i_docno,1,2)||':'||substr(b.i_docno,4,3)='").append(selProj).append("' ")
				      .append(" and a.i_company='"+(selProj.length()>=6 ? selProj.substring(0,2) : "")+"' and a.i_project='"+(selProj.length()>=6 ? selProj.substring(3,6) : "")+"' ")
					  .append("and b.d_payment = '"+dPay+"' ")   // 05-10-66 by pay
                      ...
                      if (rs.next()) {
                         if (i>=startRow && i<endRow) {
							...
							while (rs1.next()) {
							    ...
							    fContr = doString.checkString(rs1.getString("f_contr"),"N");
...
<br style="font-size:10pt">
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" height="30">
          <tr>
            ...
            <td class="act_tab4"><a href="<%=Constants.APP_PATH%>/SERV_VP_List2.jsp?i_company=<%=selProj.length()>=2 ? selProj.substring(0,2) : ""%>&d_payment=<%=dPayment%>" target="_self"><img border="0" src="images/bu_back.gif" align="absmiddle" width="50" height="15"></a>&nbsp;
...
<%      
        System.out.println("-------- SERV_VP_List4.jsp --------- ");
	} catch (Exception e) {
		System.out.println("ERROR SERV_VP_List4.jsp : " + e.getMessage());
