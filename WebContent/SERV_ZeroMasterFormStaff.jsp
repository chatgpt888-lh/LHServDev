...
<HTML>
<HEAD>
<TITLE>กำหนดโครงการที่รับผิดชอบ Zero Defect</TITLE>
...
function doAdd(action){
       if (document.form.projectDDL.value=="") {
            alert("กรุณาเลือกโครงการด้วย..");
            document.form.projectDDL.focus();
            return false;
       }  
       document.form.action="<%=request.getContextPath()%>/SERV_ZeroDefectMasterServlet?cmd=action&mode="+action;
       document.forms[0].submit();
}

function deleteData() {
      if (confirm("คุณต้องการลบข้อมูลที่ทำการเลือกทั้งหมดนี้ ?")) {
		    document.forms[0].action ="<%=request.getContextPath()%>/SERV_ZeroDefectMasterServlet?cmd=action&mode=delete";
		    document.forms[0].submit();
	   } 
}
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td class="item ; dotline01" height="22" width="12%">ชื่อพนักงาน :</td>
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        ...
        <%     }
         ...
         %>
	        ...
	        <tr>
	          <td   colspan="3" align="center" class="dotline" >&nbsp;----ไม่มีรายการ----</td>
	        </tr>
	         <tr>
	          <td   colspan="3" align="center" class="dotline" >&nbsp;</td>
	        </tr>
