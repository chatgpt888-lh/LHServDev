...
function PrintLetter(frm) {
	frm.target = "_blank";
	//frm.action = "/LHServ/PrintInfLetter6Servlet";
	frm.action = "https://www7.lh.co.th/LHServ/PrintInfLetter6Servlet";
	frm.submit();
	frm.target = "_self";
}  
//-->
...
<FORM NAME="frmLetter" METHOD=POST ACTION="/LHServ/SERV_PrintInfLetterCar">
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				<td width="50%" class="bigh"><img border="0"
					src="images/i_home.gif" align="absmiddle" width="20" height="20">&nbsp;จดหมายแจ้งขอระงับการจดทะเบียนสิทธิและนิติกรรม</td>
...
%>
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td class="item_tab2" width="300">จดหมายแจ้งขอระงับการจดทะเบียนสิทธิและนิติกรรม </td>
...
%> 									
					...
					<tr>					
                  <td class="item ; dotline01" height="22" width="11%">ลงวันที่
                    :</td>
                  <td height="22" class="dotline01" width="89%"><%date_util.printHtmlThaiDateNoTime(out, "Prnt", "", 5, 2, "white", "#0078FF");%></td>
					</tr>
					
					<tr>					
                  <td class="item ; dotline01" height="22" width="11%">ฉบับที่ 1
                    :</td>
                  <td height="22" class="dotline01" width="89%"><%date_util.printHtmlThaiDateNoTime(out, "Prnt1", "", 5, 2, "white", "#0078FF");%></td>
					</tr>
					
					<tr>					
                  <td class="item ; dotline01" height="22" width="11%">ฉบับที่ 2
                    :</td>
                  <td height="22" class="dotline01" width="89%"><%date_util.printHtmlThaiDateNoTime(out, "Prnt2", "", 5, 2, "white", "#0078FF");%></td>
					</tr>
					
					<tr>					
                  <td class="item ; dotline01" height="22" width="11%">ฉบับที่ 3
                    :</td>
                  <td height="22" class="dotline01" width="89%"><%date_util.printHtmlThaiDateNoTime(out, "Prnt3", "", 5, 2, "white", "#0078FF");%></td>
					</tr>
					
					
										
					<tr>					
                  <td class="item ; dotline01" height="22" width="11%">ภายในวันที่ 
                  <td height="22" class="dotline01" width="89%"><%date_util.printHtmlThaiDateNoTime(out, "Finish", "", 5, 2, "white", "#0078FF");%></td>
					</tr>
		
	
					
					<tr>
                  <td class="item ; dotline01" height="22" width="11%">ชื่อผู้ติดต่อ :</td>
                  <td height="22" class="dotline01" width="89%"><input type="text" name="Contact" class="box" style="width:250px" value=""></td>
					</tr>
															
					<tr>					
                  <td class="item ; dotline01" height="22" width="11%">เบอร์โทรศัพท์ :</td>
                  <td height="22" class="dotline01" width="89%"><input type="text" name="Phone" class="box" style="width:250px" value=""></td>
					</tr>						
...
<%
		...
		System.out.println("ERROR SERV_PrintInfLetter6.jsp : " + e.getMessage());
