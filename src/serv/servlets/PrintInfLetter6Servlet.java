 ...
 * @author
 */
public class PrintInfLetter6Servlet extends DBServlet  {
	...
	public void printLetter(Document document, String printDate, String inf_year, String projNme, String endDate) throws Exception {
	  ...
	  table.addCell(addCellData("ฉบับที่ 6","L","C","",10,microssfont));
	  ...
	  table.addCell(addCellData("ขอระงับการจดทะเบียนสิทธิและนิติกรรม","L","C","",95-3,microssfont));
	  ...
	  table.addCell(addCellData("สิ่งที่ส่งมาด้วย","L","C","",13,microssfont));
	  table.addCell(addCellData("1. ใบแจ้งการชำระเงิน พร้อมแบบฟอร์มการชำระเงินที่ธนาคาร (ใบ PAY-IN)","L","C","",87,microssfont));
	  
	  table.addCell(addCellData(" ","L","C","",13,microssfont));
	  table.addCell(addCellData("2. ประกาศคณะกรรมการจัดสรรที่ดินกลาง เรื่อง กำหนดหลักเกณฑ์และวิธีการระงับการจดทะเบียนสิทธิ","L","C","",87,microssfont));
	  table.addCell(addCellData(" ","L","C","",13,microssfont));
	  table.addCell(addCellData("และนิติกรรมในที่ดินจัดสรร","L","C","",87,microssfont));
	  
	  table.addCell(addCellData(" ","L","C","",5+3,microssfont));
	  table.addCell(addCellData("บริษัท แลนด์ แอนด์ เฮ้าส์ จำกัด (มหาชน) ขอขอบคุณท่านเจ้าของบ้านทุกท่านที่ได้ให้ความร่วมมือในการชำระ","L","C","",95-3,microssfont));
	  table.addCell(addCellData("ค่าบริการสาธารณะประจำปี "+inf_year+" สำหรับท่านเจ้าของบ้านท่านใดที่ยังไม่ได้ชำระค่าบริการดังกล่าว","L","C","",100,microssfont));
	  table.addCell(addCellData("โปรดชำระค่าบริการภายในวันที่ "+endDate,"L","C","",100,microssfont_BOLD));
	  
	  table.addCell(addCellData(" ","L","C","",5+3,microssfont));
	  table.addCell(addCellData("อนึ่งหากพ้นกำหนดระยะเวลาดังกล่าวแล้ว บริษัทฯ มีความจำเป็นที่จะต้องแจ้งให้","L","C","",95-3,microssfont));
	  table.addCell(addCellData("เจ้าพนักงานที่ดินจังหวัด หรือเจ้าพนักงานที่ดินจังหวัดสาขาระงับการจดทะเบียนสิทธิและนิติกรรมในที่ดินของท่าน","L","C","",100,microssfont_BOLD));
	  table.addCell(addCellData("ทั้งนี้หากท่านได้ชำระเงินค่าบริการสาธารณะไปก่อนที่ท่านได้รับจดหมายฉบับนี้ บริษัทฯ ต้องกราบขออภัย","L","C","",100,microssfont));
	  table.addCell(addCellData("ท่านมา ณ โอกาสนี้ด้วย","L","C","",100,microssfont));
	  
	  table.addCell(addCellData(" ","L","C","",100,microssfont));
	  
	  table.addCell(addCellData(" ","L","C","",5+3,microssfont));
	  table.addCell(addCellData("จีงเรียนมาเพื่อทราบและโปรดให้ความร่วมมือในการชำระค่าบริการดังกล่าว","L","C","",95-3,microssfont));
...
*/						
		  ...
		  conn = null;
			 ...
			 System.err.println("error PrintInfLetter6Servlet  DOCUMENT: " + de.getMessage());
		} catch (Exception e) {
