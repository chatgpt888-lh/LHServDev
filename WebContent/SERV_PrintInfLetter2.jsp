...
<!--
  function PrintLetter(frm) {
	 frm.target = "_blank";
	 frm.action = "https://www7.lh.co.th/LHServ/PrintInfLetter2Servlet";
	 //frm.action = "/LHServ/PrintInfLetter2Servlet";
     frm.submit();
	 frm.target = "_self";
  }
  function ChangeYear(frm) {
	 frm.action = "/LHServ/SERV_PrintInfLetter2.jsp";
     frm.submit();
  }
...
%>
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td class="item_tab2" width="250">จดหมายแจ้งอัตราการจัดเก็บค่าบริการสาธารณะประจำปี </td>
