...
<HTML>
<HEAD>
<TITLE>สรุปงานซ่อมประจำเดือน</TITLE>
...
<!--
  ...
  function goReport() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_Report5_1.jsp";
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr> 
				...
				<%=common.genYearListbox("year_report",maxYear," class='box' ",2012,5)%>				  
				 </td>
              </tr>
              <tr> 
...
<%
		...
		System.out.println("ERROR SERV_Report5.jsp : " + e.getMessage());
