...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
   ...
   <tr>
    <td width="55%" class="item ; dotline" align="left"><img border="0" src="images/i_arrow1.gif" align="absmiddle" width="13" height="13">E-Service รอเปิด Inform Job</td>
    <td width="15%" class="dotline" align="center"><a href="ESERV_OpenJob_List.jsp?criteria=<%=param %>&sel_project=<%=selProj%>"><%=eServCount%></a></td>
...
<%
	...
	if (viewAllStaffProj) {
		...
		sql.append(" SELECT DISTINCT b.i_docno FROM lan:serv_pstaff a,lan:serv_infdochd b, lan:serv_infdocdt c ")
			  ...
			  .append(" AND c.i_itmtype = '02' AND c.f_itmstatus = '300' AND c.i_docno = b.i_docno ")
			  .append(" AND a.user_id = '"+userId+"' AND a.com_id = b.i_company ")
			  .append(" AND a.proj_id = b.i_project ");
	} else {
	...
	if (viewAllStaffProj) {
		...
		sql.append(" SELECT COUNT(*) FROM lan:serv_pstaff a,lan:serv_infdochd b,lan:serv_infpayment c ")
			  .append(" WHERE b.f_status = 'OPN' AND b.i_doc_type = 'J' ")
			  .append(" AND c.i_itmtype = '02' AND c.f_itmstatus = '400' AND c.i_docno = b.i_docno ")
			  .append(" AND a.user_id = '"+userId+"' AND a.com_id = b.i_company ")
			  .append(" AND a.proj_id = b.i_project ")
			  .append(" GROUP BY b.i_docno ");
	} else {
		sql.append("SELECT COUNT(*) FROM lan:serv_infdochd a, lan:serv_infpayment b ")
			.append("WHERE a.f_status = 'OPN' AND a.i_doc_type = 'J' AND b.i_itmtype = '02' AND b.f_itmstatus = '400' ")
			.append("AND b.i_docno = a.i_docno ").append(condition)
			.append(" GROUP BY a.i_docno");
	}
	completePass = countResultRow(stmt,sql.toString(),servlog);
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="7%" class="dotline" align="center"><a href="SERV_Contractor_List.jsp?sel_project=<%=selProj%>&d_payment=<%=showCurrentPaymentDate%>"><%=cConstructorWait%></a></td>
  ...
  <tr>
    ...
    <td width="7%" class="dotline" align="center"><a href="SERV_Staff_List.jsp?sel_project=<%=selProj%>&d_payment=<%=showCurrentPaymentDate%>"><%=cServiceStaffWait%></a></td>
  ...
  <tr>
    ...
    <td width="7%" class="dotline" align="center"><a href="SERV_Manager_List.jsp?sel_project=<%=selProj%>&d_payment=<%=showCurrentPaymentDate%>"><%=cServiceManagerWait%></a></td>
  ...
  <tr>
    ...
    <td width="7%" class="dotline" align="center"><a href="SERV_Zone_List.jsp?sel_project=<%=selProj%>&d_payment=<%=showCurrentPaymentDate%>"><%=cManagerWait%></a></td>
  ...
  <tr>
    ...
    <td width="7%" class="dotline" align="center"><a href="SERV_VP_List.jsp?sel_project=<%=selProj%>&d_payment=<%=showCurrentPaymentDate%>"><%=cVPWait%></a></td>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="7%" class="dotline" align="center"><a href="SERV_Contractor_List.jsp?sel_project=<%=selProj%>&d_payment=<%=showNextPaymentDate%>"><%=nConstructorWait%></a></td>
  ...
  <tr>
    ...
    <td width="7%" class="dotline" align="center"><a href="SERV_Staff_List.jsp?sel_project=<%=selProj%>&d_payment=<%=showNextPaymentDate%>"><%=nServiceStaffWait%></a></td>
  ...
  <tr>
    ...
    <td width="7%" class="dotline" align="center"><a href="SERV_Manager_List.jsp?sel_project=<%=selProj%>&d_payment=<%=showNextPaymentDate%>"><%=nServiceManagerWait%></a></td>
  ...
  <tr>
    ...
    <td width="7%" class="dotline" align="center"><a href="SERV_Zone_List.jsp?sel_project=<%=selProj%>&d_payment=<%=showNextPaymentDate%>"><%=nManagerWait%></a></td>
  ...
  <tr>
    ...
    <td width="7%" class="dotline" align="center"><a href="SERV_VP_List.jsp?sel_project=<%=selProj%>&d_payment=<%=showNextPaymentDate%>"><%=nVPWait%></a></td>
