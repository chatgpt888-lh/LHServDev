...
<LINK rel="StyleSheet" href="EISMainStyle.css" type="text/css">
...
%>
<FORM NAME="frmEIS" METHOD=POST ACTION="EIS_ServExpenceMonthDetail.jsp">
...
<%
	...
	System.out.println("!!!ERROR EIS_ServExpenceMonthDetail.jsp : " + e.getMessage());
	System.out.println("!!!ERROR EIS_ServExpenceMonthDetail.jsp SQL : " + sql.toString());
