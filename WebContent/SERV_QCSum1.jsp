...
<%
   ...
   //----============ Declare Variables for input data ===========----//
	...
	if(Integer.toString(rightNow.get(Calendar.MONTH)+1).length() == 1) {
		cur_month = "0" + Integer.toString(rightNow.get(Calendar.MONTH)+1);
	} else {
		cur_month = Integer.toString(rightNow.get(Calendar.MONTH)+1);
	}
...
<!--
  ...
  function goReport() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_QCSum1_1.jsp";
...
<FORM ACTION="SERV_QCSum1_1.jsp" METHOD="POST" name="frm">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr> 
				...
				<%=common.genMonthListbox("month_report",cur_month," class='box' ")%>
				</td>
...
<%
		...
		System.out.println("ERROR SERV_QCSum1.jsp : " + e.getMessage());
