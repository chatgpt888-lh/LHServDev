...
<!--
  ...
  function searchDocHD() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_INFPass_Full.jsp";
...
<FORM METHOD="POST" ACTION="">
    ...
    <input type="hidden" name="success_page" value="SERV_INFPass_List.jsp?itmType=<%=itmType%>">
    <input type="hidden" name="error_page" value="SERV_INFPass_Full.jsp?error=1&itmType=<%=itmType%>">
      ...
      <td width="50%" class="bigh"><img border="0" src="images/i_home.gif" align="absmiddle" width="20" height="20">&nbsp; 
        ใบสั่งซ่อม - อนุมัติแล้ว</td>
          <td width="50%" align="right">
          <table border="0" width="140" cellspacing="0" cellpadding="0">
              <tr>
                
            <td width="100%" class="TextMenu"><a href="SERV_INFPass_List.jsp?itmType=<%=itmType%>&sel_project=<%=selProj%>&d_payment=<%=dPayment%>"><img border="0" src="images/i_arrow1.gif" align="absmiddle" width="15" height="15"> 
              แสดงแบบสรุป</a></td>
              </tr>
          </table>    
			</td>
...
<%
		     //----================== Select Data from SERV_INFDOCHD ================----//   
		        ...
		        sql.append("SELECT FIRST ").append(endRow).append(" a.i_docno, c.n_project")
		              ...
		              .append(" a.f_status IN ('OPN', 'CLS') "+team_condition+" AND b.i_docno = a.i_docno")
      ...
      <td class="textgray"><%=projectName%>&nbsp;&nbsp; เลขที่ใบสั่งซ่อม 
...
<br style="font-size:10pt">
      ...
      <td class="act_tab4"><a href="SERV_INFPass_List.jsp?itmType=<%=itmType%>" target="_self"><img border="0" src="images/bu_back.gif" align="absmiddle" width="50" height="15"></a>&nbsp; 
...
<%
		...
		System.out.println("ERROR SERV_INFPass_Full.jsp : " + e.getMessage());
