...
String jName = "EIS_ServAllProjExpenceMnt.jsp";
...
%>
<FORM NAME="frmEIS" METHOD=POST ACTION="EIS_ServAllProjExpenceMnt.jsp">
...
<br style="font-size:8pt">
  ...
  <table border="0" width="100%" cellspacing="1" cellpadding="0">
    <tr>
	  ...
	  <OPTION value="LHALL">------ ทุกโครงการ (ไม่รวม G5, G10, G12)--------</OPTION> 
<%
String option = "";

if(user.getUserWho().equals("T") || user.getUserWho().equals("C") || user.getUserWho().equals("A") || user.getUserID().equals("piyapong") || user.getUserWho().equals("P") || user.getUserWho().equals("Z") || user.getUserWho().equals("M")) { 
...
<%
		...
		if (typecost.equals("A")) {
			...
			if (project.equals("LHALL")) {
				sum_detail = "sum(a.z_expst_m1) as m1, sum(a.z_expst_m2) as m2, sum(a.z_expst_m3) as m3, sum(a.z_expst_m4) as m4, sum(a.z_expst_m5) as m5, ";
				sum_detail += "sum(a.z_expst_m6) as m6, sum(a.z_expst_m7) as m7, sum(a.z_expst_m8) as m8, sum(a.z_expst_m9) as m9, sum(a.z_expst_m10) as m10, ";
				sum_detail += "sum(a.z_expst_m11) as m11, sum(a.z_expst_m12) as m12, sum(a.z_expst_m13) as m13, ";
				sum_detail += "sum(a.z_expst_m1+a.z_expst_m2+a.z_expst_m3+a.z_expst_m4+a.z_expst_m5+a.z_expst_m6) as sm1, sum(a.z_expst_m7+a.z_expst_m8+a.z_expst_m9+a.z_expst_m10+a.z_expst_m11+a.z_expst_m12) as sm2";

				Bsum_detail = "sum(a.z_bugst_m1) as m1, sum(a.z_bugst_m2) as m2, sum(a.z_bugst_m3) m3, sum(a.z_bugst_m4) as m4, sum(a.z_bugst_m5) as m5, ";
				Bsum_detail += "sum(a.z_bugst_m6) as m6, sum(a.z_bugst_m7) as m7, sum(a.z_bugst_m8) as m8, sum(a.z_bugst_m9) as m9, sum(a.z_bugst_m10) as m10, ";
				Bsum_detail += "sum(a.z_bugst_m11) as m11, sum(a.z_bugst_m12) as m12, sum(a.z_bugst_m13) as m13, ";
				Bsum_detail += "sum(a.z_bugst_m1+a.z_bugst_m2+a.z_bugst_m3+a.z_bugst_m4+a.z_bugst_m5+a.z_bugst_m6) as sm1, sum(a.z_bugst_m7+a.z_bugst_m8+a.z_bugst_m9+a.z_bugst_m10+a.z_bugst_m11+a.z_bugst_m12) as sm2";
			} else {
				sum_detail = "a.z_expst_m1 m1, a.z_expst_m2 m2, a.z_expst_m3 m3, a.z_expst_m4 m4, a.z_expst_m5 m5, ";
				sum_detail += "a.z_expst_m6 m6, a.z_expst_m7 m7, a.z_expst_m8 m8, a.z_expst_m9 m9, a.z_expst_m10 m10, ";
				sum_detail += "a.z_expst_m11 m11, a.z_expst_m12 m12, a.z_expst_m13 m13, ";
				sum_detail += "(a.z_expst_m1+a.z_expst_m2+a.z_expst_m3+a.z_expst_m4+a.z_expst_m5+a.z_expst_m6) sm1, (a.z_expst_m7+a.z_expst_m8+a.z_expst_m9+a.z_expst_m10+a.z_expst_m11+a.z_expst_m12) sm2";

				Bsum_detail = "a.z_bugst_m1 m1, a.z_bugst_m2 m2, a.z_bugst_m3 m3, a.z_bugst_m4 m4, a.z_bugst_m5 m5, ";
				Bsum_detail += "a.z_bugst_m6 m6, a.z_bugst_m7 m7, a.z_bugst_m8 m8, a.z_bugst_m9 m9, a.z_bugst_m10 m10, ";
				Bsum_detail += "a.z_bugst_m11 m11, a.z_bugst_m12 m12, a.z_bugst_m13 m13, ";
				Bsum_detail += "(a.z_bugst_m1+a.z_bugst_m2+a.z_bugst_m3+a.z_bugst_m4+a.z_bugst_m5+a.z_bugst_m6) sm1, (a.z_bugst_m7+a.z_bugst_m8+a.z_bugst_m9+a.z_bugst_m10+a.z_bugst_m11+a.z_bugst_m12) sm2";
			} // end if project
		 ...
		 if (project.equals("LHALL")) {
				sum_detail = "sum(a.z_expal_m1) m1, sum(a.z_expal_m2) m2, sum(a.z_expal_m3) m3, sum(a.z_expal_m4) m4, sum(a.z_expal_m5) m5, ";
				sum_detail += "sum(a.z_expal_m6) m6, sum(a.z_expal_m7) m7, sum(a.z_expal_m8) m8, sum(a.z_expal_m9) m9, sum(a.z_expal_m10) m10, ";
				sum_detail += "sum(a.z_expal_m11) m11, sum(a.z_expal_m12) m12, sum(a.z_expal_m13) m13, ";
				sum_detail += "sum(a.z_expal_m1+a.z_expal_m2+a.z_expal_m3+a.z_expal_m4+a.z_expal_m5+a.z_expal_m6) sm1, sum(a.z_expal_m7+a.z_expal_m8+a.z_expal_m9+a.z_expal_m10+a.z_expal_m11+a.z_expal_m12) sm2";

				Bsum_detail = "sum(a.z_bugal_m1) m1, sum(a.z_bugal_m2) m2, sum(a.z_bugal_m3) m3, sum(a.z_bugal_m4) m4, sum(a.z_bugal_m5) m5, ";
				Bsum_detail += "sum(a.z_bugal_m6) m6, sum(a.z_bugal_m7) m7, sum(a.z_bugal_m8) m8, sum(a.z_bugal_m9) m9, sum(a.z_bugal_m10) m10, ";
				Bsum_detail += "sum(a.z_bugal_m11) m11, sum(a.z_bugal_m12) m12, sum(a.z_bugal_m13) m13, ";
				Bsum_detail += "sum(a.z_bugal_m1+a.z_bugal_m2+a.z_bugal_m3+a.z_bugal_m4+a.z_bugal_m5+a.z_bugal_m6) sm1, sum(a.z_bugal_m7+a.z_bugal_m8+a.z_bugal_m9+a.z_bugal_m10+a.z_bugal_m11+a.z_bugal_m12) sm2";
		 } else {
			    sum_detail = "a.z_expal_m1 m1, a.z_expal_m2 m2, a.z_expal_m3 m3, a.z_expal_m4 m4, a.z_expal_m5 m5, ";
				sum_detail += "a.z_expal_m6 m6, a.z_expal_m7 m7, a.z_expal_m8 m8, a.z_expal_m9 m9, a.z_expal_m10 m10, ";
				sum_detail += "a.z_expal_m11 m11, a.z_expal_m12 m12, a.z_expal_m13 m13, ";
				sum_detail += "(a.z_expal_m1+a.z_expal_m2+a.z_expal_m3+a.z_expal_m4+a.z_expal_m5+a.z_expal_m6) sm1, (a.z_expal_m7+a.z_expal_m8+a.z_expal_m9+a.z_expal_m10+a.z_expal_m11+a.z_expal_m12) sm2";

				Bsum_detail = "a.z_bugal_m1 m1, a.z_bugal_m2 m2, a.z_bugal_m3 m3, a.z_bugal_m4 m4, a.z_bugal_m5 m5, ";
				Bsum_detail += "a.z_bugal_m6 m6, a.z_bugal_m7 m7, a.z_bugal_m8 m8, a.z_bugal_m9 m9, a.z_bugal_m10 m10, ";
				Bsum_detail += "a.z_bugal_m11 m11, a.z_bugal_m12 m12, a.z_bugal_m13 m13, ";
				Bsum_detail += "(a.z_bugal_m1+a.z_bugal_m2+a.z_bugal_m3+a.z_bugal_m4+a.z_bugal_m5+a.z_bugal_m6) sm1, (a.z_bugal_m7+a.z_bugal_m8+a.z_bugal_m9+a.z_bugal_m10+a.z_bugal_m11+a.z_bugal_m12) sm2";
		 }
			...
			if (project.equals("LHALL")) {
				...
				btype_id = "= '1'";
			if (project.equals("LHALL")) {
				sum_detail = "sum(a.z_expst_m1+a.z_expal_m1) m1, sum(a.z_expst_m2+a.z_expal_m2) m2, sum(a.z_expst_m3+a.z_expal_m3) m3, sum(a.z_expst_m4+a.z_expal_m4) m4, sum(a.z_expst_m5+a.z_expal_m5) m5, ";
				sum_detail += "sum(a.z_expst_m6+a.z_expal_m6) m6, sum(a.z_expst_m7+a.z_expal_m7) m7, sum(a.z_expst_m8+a.z_expal_m8) m8, sum(a.z_expst_m9+a.z_expal_m9) m9, sum(a.z_expst_m10+a.z_expal_m10) m10, ";
				sum_detail += "sum(a.z_expst_m11+a.z_expal_m11) m11, sum(a.z_expst_m12+a.z_expal_m12) m12, sum(a.z_expst_m13+a.z_expal_m13) m13, ";
				sum_detail += "sum(a.z_expst_m1+a.z_expal_m1+a.z_expst_m2+a.z_expal_m2+a.z_expst_m3+a.z_expal_m3+a.z_expst_m4+a.z_expal_m4+a.z_expst_m5+a.z_expal_m5+a.z_expst_m6+a.z_expal_m6) sm1, ";
				sum_detail += "sum(a.z_expst_m7+a.z_expal_m7+a.z_expst_m8+a.z_expal_m8+a.z_expst_m9+a.z_expal_m9+a.z_expst_m10+a.z_expal_m10+a.z_expst_m11+a.z_expal_m11+a.z_expst_m12+a.z_expal_m12) sm2";

				Bsum_detail = "sum(a.z_bugst_m1+a.z_bugal_m1) m1, sum(a.z_bugst_m2+a.z_bugal_m2) m2, sum(a.z_bugst_m3+a.z_bugal_m3) m3, sum(a.z_bugst_m4+a.z_bugal_m4) m4, sum(a.z_bugst_m5+a.z_bugal_m5) m5, ";
				Bsum_detail += "sum(a.z_bugst_m6+a.z_bugal_m6) m6, sum(a.z_bugst_m7+a.z_bugal_m7) m7, sum(a.z_bugst_m8+a.z_bugal_m8) m8, sum(a.z_bugst_m9+a.z_bugal_m9) m9, sum(a.z_bugst_m10+a.z_bugal_m10) m10, ";
				Bsum_detail += "sum(a.z_bugst_m11+a.z_bugal_m11) m11, sum(a.z_bugst_m12+a.z_bugal_m12) m12, sum(a.z_bugst_m13+a.z_bugal_m13) m13, ";
				Bsum_detail += "sum(a.z_bugst_m1+a.z_bugal_m1+a.z_bugst_m2+a.z_bugal_m2+a.z_bugst_m3+a.z_bugal_m3+a.z_bugst_m4+a.z_bugal_m4+a.z_bugst_m5+a.z_bugal_m5+a.z_bugst_m6+a.z_bugal_m6) sm1, ";
				Bsum_detail += "sum(a.z_bugst_m7+a.z_bugal_m7+a.z_bugst_m8+a.z_bugal_m8+a.z_bugst_m9+a.z_bugal_m9+a.z_bugst_m10+a.z_bugal_m10+a.z_bugst_m11+a.z_bugal_m11+a.z_bugst_m12+a.z_bugal_m12) sm2";
			} else {
				sum_detail = "(a.z_expst_m1+a.z_expal_m1) m1, (a.z_expst_m2+a.z_expal_m2) m2, (a.z_expst_m3+a.z_expal_m3) m3, (a.z_expst_m4+a.z_expal_m4) m4, (a.z_expst_m5+a.z_expal_m5) m5, ";
				sum_detail += "(a.z_expst_m6+a.z_expal_m6) m6, (a.z_expst_m7+a.z_expal_m7) m7, (a.z_expst_m8+a.z_expal_m8) m8, (a.z_expst_m9+a.z_expal_m9) m9, (a.z_expst_m10+a.z_expal_m10) m10, ";
				sum_detail += "(a.z_expst_m11+a.z_expal_m11) m11, (a.z_expst_m12+a.z_expal_m12) m12, (a.z_expst_m13+a.z_expal_m13) m13, ";
				sum_detail += "(a.z_expst_m1+a.z_expal_m1+a.z_expst_m2+a.z_expal_m2+a.z_expst_m3+a.z_expal_m3+a.z_expst_m4+a.z_expal_m4+a.z_expst_m5+a.z_expal_m5+a.z_expst_m6+a.z_expal_m6) sm1, ";
				sum_detail += "(a.z_expst_m7+a.z_expal_m7+a.z_expst_m8+a.z_expal_m8+a.z_expst_m9+a.z_expal_m9+a.z_expst_m10+a.z_expal_m10+a.z_expst_m11+a.z_expal_m11+a.z_expst_m12+a.z_expal_m12) sm2";

				Bsum_detail = "(a.z_bugst_m1+a.z_bugal_m1) m1, (a.z_bugst_m2+a.z_bugal_m2) m2, (a.z_bugst_m3+a.z_bugal_m3) m3, (a.z_bugst_m4+a.z_bugal_m4) m4, (a.z_bugst_m5+a.z_bugal_m5) m5, ";
				Bsum_detail += "(a.z_bugst_m6+a.z_bugal_m6) m6, (a.z_bugst_m7+a.z_bugal_m7) m7, (a.z_bugst_m8+a.z_bugal_m8) m8, (a.z_bugst_m9+a.z_bugal_m9) m9, (a.z_bugst_m10+a.z_bugal_m10) m10, ";
				Bsum_detail += "(a.z_bugst_m11+a.z_bugal_m11) m11, (a.z_bugst_m12+a.z_bugal_m12) m12, (a.z_bugst_m13+a.z_bugal_m13) m13, ";
				Bsum_detail += "(a.z_bugst_m1+a.z_bugal_m1+a.z_bugst_m2+a.z_bugal_m2+a.z_bugst_m3+a.z_bugal_m3+a.z_bugst_m4+a.z_bugal_m4+a.z_bugst_m5+a.z_bugal_m5+a.z_bugst_m6+a.z_bugal_m6) sm1, ";
				Bsum_detail += "(a.z_bugst_m7+a.z_bugal_m7+a.z_bugst_m8+a.z_bugal_m8+a.z_bugst_m9+a.z_bugal_m9+a.z_bugst_m10+a.z_bugal_m10+a.z_bugst_m11+a.z_bugal_m11+a.z_bugst_m12+a.z_bugal_m12) sm2";
			}
...
WHERE NOT EXISTS (
    ...
    WHERE v.i_company = a.i_company
	  ...
	  */
							   ...
							   sql.delete(0, sql.length());
							   sql.append("select "+sum_detail+" from lan:acbexpsm a ") 
									.append("where a.i_year = '"+year+"' ");         
					if (project.equals("LHALL")) {
								sql.append("and not exists (select b.i_company, b.i_project from lan:serv_local b where a.i_company = b.i_company and a.i_project = b.i_project) ")
							        .append("and a.i_project <> '099' ");      
					} else {
							   sql.append("and a.i_company = '"+i_com+"' ")                                        
									.append("and a.i_project = '"+i_proj+"' ");        
					}									
							   sql.append("and a.i_acctno != 'TOTAL' ")
									.append("and a.i_type "+type_id+" ")       							
								    .append("and a.i_acctno = '"+doString.DisplayThai(doString.checkString(rs.getString("i_acctno")))+"' ");			
								rs1 = stmt1.executeQuery(sql.toString());
								if (rs1.next()==true) {
							  ...
							  //----------------------  BUDGET -------------------------------							
								   sql.delete(0, sql.length());
								   sql.append("select "+Bsum_detail+", a.i_acctno from lan:acbexpbg a ") 
										.append("where a.i_year = '"+year+"' ");                                 
						if (project.equals("LHALL")) {
								sql.append("and not exists (select b.i_company, b.i_project from lan:serv_local b where a.i_company = b.i_company and a.i_project = b.i_project) ");
						} else {
							   sql.append("and a.i_company = '"+i_com+"' ")                                        
								   ...
								   sql.append("and a.i_acctno != 'TOTAL' ")
										.append("and a.i_acctno = '"+doString.DisplayThai(doString.checkString(rs.getString("i_acctno")))+"' ")
										.append("and a.i_type "+btype_id+" ");
							if (project.equals("LHALL")) {
									sql.append("group by i_acctno ");
							}
									rs1 = stmt1.executeQuery(sql.toString());
									if (rs1.next()) {															
...
%>
     <tr class="col_right ; specH1 ; white">
      ...
      <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=01&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m1)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m2)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=02&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m2)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m3)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=03&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m3)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m4)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=04&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m4)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m5)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=05&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m5)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m6)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=06&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m6)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m7)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=07&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m7)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m8)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=08&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m8)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m9)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=09&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m9)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m10)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=10&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m10)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m11)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=11&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m11)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m12)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=12&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m12)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_sm1)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=Q1&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_sm1)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_sm2)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=Q2&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_sm2)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m13)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=ALL&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m13)%></A></td>
...
if (typecost.equals("C") || typecost.equals("E")) {
				b_m1 = 0; b_m2 = 0;b_m3 = 0;b_m4 = 0;b_m5 = 0;b_m6 = 0;b_m7 = 0;b_m8 = 0;b_m9 = 0;b_m10 = 0;b_m11 = 0;b_m12 = 0;b_m13 = 0;b_sm1 = 0;b_sm2 = 0;
				 v_m1 = 0; v_m2 = 0;v_m3 = 0;v_m4 = 0;v_m5 = 0;v_m6 = 0;v_m7 = 0;v_m8 = 0;v_m9 = 0;v_m10 = 0;v_m11 = 0;v_m12 = 0;v_m13 = 0;v_sm1 = 0;v_sm2 = 0;
				  ...
				  //----------------------  ACTUAL -----------------------------
				   sql.delete(0, sql.length());
				   sql.append("select "+sum_detail+", a.i_acctno from lan:acbexpsm a ") 
						.append("where a.i_year = '"+year+"' ");                                 
				if (project.equals("LHALL")) {
						sql.append("and not exists (select b.i_company, b.i_project from lan:serv_local b where a.i_company = b.i_company and a.i_project = b.i_project) ");
				} else {
					...
					sql.append("and a.i_acctno = 'TOTAL' ")
						.append("and a.i_acctno not in (select c.i_acctno from lan:acbstdep c where c.i_type = '5-ser' and c.i_acctno = a.i_acctno) ")  
						.append("and a.i_type = '3' ");
				if (project.equals("LHALL")) {
					sql.append("group by a.i_acctno ");
				}
				    rs1 = stmt1.executeQuery(sql.toString());
					if (rs1.next()==true) {		
				     ...
				     //----------------------  BUDGET -----------------------------
					   sql.delete(0, sql.length());
					   sql.append("select a.z_amount, month(a.d_cash) as mnt_cash ")                                                     
							.append("from lan:acbcasfd a ")                                                               
							.append("where a.i_bud_type = '1' ")                                                          
							.append("and a.i_code = '110' ")                                                              
							.append("and a.i_detail = '002' ")                                                            
							.append("and year(a.d_cash) = '"+(Integer.parseInt(year)-543)+"' ");                                  
						if (project.equals("LHALL")) {
								sql.append("and not exists (select b.i_company, b.i_project from lan:serv_local b where a.i_company = b.i_company and a.i_project = b.i_project) ");
						} else {
							   sql.append("and a.i_company = '"+i_com+"' ")                                        
						...
						while (rs.next()==true) {	
								...
								if (doString.checkString(doString.DisplayThai(rs.getString("mnt_cash"))).equals("1")) {
										//v_m1 = rs.getDouble("a.z_amount")/1000;		
				...
				while (rs.next()) {
						acct_desc = doString.DisplayThai(doString.checkString(rs.getString("acct_desc")));
							...
							if (doString.checkString(rs.getString("i_acctno")).equals("54010") || doString.checkString(rs.getString("i_acctno")).equals("54011") || doString.checkString(rs.getString("i_acctno")).equals("54012")) {
							 ...
							 //----------------------  ACTUAL -------------------------------
							   sql.delete(0, sql.length());
							   sql.append("select "+sum_detail+" from lan:acbidrsm a ") 
									.append("where a.i_year = '"+year+"' ");                                  
						 	if (project.equals("LHALL")) {
								sql.append("and not exists (select b.i_company, b.i_project from lan:serv_local b where a.i_company = b.i_company and a.i_project = b.i_project) ");
							} else {
							  ...
							  //----------------------  BUDGET -------------------------------							
								   sql.delete(0, sql.length());
								   sql.append("select "+Bsum_detail+", a.i_acctno from lan:acbidrbg a ") 
										.append("where a.i_year = '"+year+"' ");                                  
						  	if (project.equals("LHALL")) {
								sql.append("and not exists (select b.i_company, b.i_project from lan:serv_local b where a.i_company = b.i_company and a.i_project = b.i_project) ");
							} else {
...
%>
  <tr class="col_right ; specH1 ; white">
	  ...
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m1)%></td>
      <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=01&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m1)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m2)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=02&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m2)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m3)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=03&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m3)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m4)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=04&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m4)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m5)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=05&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m5)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m6)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=06&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m6)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m7)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=07&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m7)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m8)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=08&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m8)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m9)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=09&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m9)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m10)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=10&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m10)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m11)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=11&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m11)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m12)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=12&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m12)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_sm1)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=Q1&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_sm1)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_sm2)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=Q2&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_sm2)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m13)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs.getString("i_acctno"))%>&acct_desc=<%=acct_desc%>&month=ALL&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m13)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", a_per1)%></td>
      <td width="50px"><%=doString.displayNumber("###,###.0", b_per1)%></td>
    </tr>
...
if (typecost.equals("C") || typecost.equals("E")) {
		...
		v_m1 = 0; v_m2 = 0;v_m3 = 0;v_m4 = 0;v_m5 = 0;v_m6 = 0;v_m7 = 0;v_m8 = 0;v_m9 = 0;v_m10 = 0;v_m11 = 0;v_m12 = 0;v_m13 = 0;v_sm1 = 0;v_sm2 = 0;
				  ...
				  //----------------------  ACTUAL -----------------------------
				   sql.delete(0, sql.length());
				   sql.append("select "+sum_detail+", a.i_acctno from lan:acbidrsm a ")   //acbexpsm
						.append("where a.i_year = '"+year+"' ");                                
					if (project.equals("LHALL")) {
								sql.append("and not exists (select b.i_company, b.i_project from lan:serv_local b where a.i_company = b.i_company and a.i_project = b.i_project) ");
						} else {
...
i_tot_vm1 = 0; i_tot_vm2 = 0; i_tot_vm3 = 0; i_tot_vm4 = 0; i_tot_vm5 = 0;i_tot_vm6 = 0; i_tot_vm7 = 0; i_tot_vm8 = 0; i_tot_vm9 = 0; i_tot_vm10 = 0; i_tot_vm11 = 0; i_tot_vm12 = 0; i_tot_vm13 = 0; i_tot_vsm1 = 0; i_tot_vsm2 = 0;
		   ...
		   sql.append("select "+Bsum_detail+", a.i_acctno from lan:acbidrbg a ") 
				...
				sql.append("and a.i_acctno in ('54010','54011','54012','52410') ")	
				     .append("and a.i_type = '3' ");
				if (project.equals("LHALL")) {
					sql.append("group by a.i_acctno ");
				}				
...
//---------------- ACTUAL ----------------
		...
		sql.delete(0, sql.length());
		sql.append("select sum(a.z_amount) as z_amount, month(a.doc_date) as mnt_cash from lan:acxgldtl a ")
		     .append("where year(a.doc_date)+543 = '"+year+"' ");
			 	if (project.equals("LHALL")) {
								sql.append("and not exists (select b.i_company, b.i_project from lan:serv_local b where a.comp_id = b.i_company and a.department = b.i_project) ");
				} else {
							   sql.append("and a.comp_id = '"+i_com+"' ")                                        
									.append("and a.department = '"+i_proj+"' ");        
				}			

	   sql.append("and a.acct_no = '"+doString.checkString(rs1.getString("i_acctno"))+"' ")
			.append("and a.orig_journal != 'GJ' ")  
			.append("group by 2 ")
			.append("order by 2 ");
		//out.println(sql.toString());
		rs2 = stmt2.executeQuery(sql.toString());
...
<tr class="col_right ; specH1 ; white">
	  ...
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m1)%></td>
      <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs1.getString("i_acctno"))%>&acct_desc=<%=acct_name%>&month=01&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m1)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m2)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs1.getString("i_acctno"))%>&acct_desc=<%=acct_name%>&month=02&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m2)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m3)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs1.getString("i_acctno"))%>&acct_desc=<%=acct_name%>&month=03&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m3)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m4)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs1.getString("i_acctno"))%>&acct_desc=<%=acct_name%>&month=04&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m4)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m5)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs1.getString("i_acctno"))%>&acct_desc=<%=acct_name%>&month=05&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m5)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m6)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs1.getString("i_acctno"))%>&acct_desc=<%=acct_name%>&month=06&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m6)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m7)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs1.getString("i_acctno"))%>&acct_desc=<%=acct_name%>&month=07&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m7)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m8)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs1.getString("i_acctno"))%>&acct_desc=<%=acct_name%>&month=08&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m8)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m9)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs1.getString("i_acctno"))%>&acct_desc=<%=acct_name%>&month=09&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m9)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m10)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs1.getString("i_acctno"))%>&acct_desc=<%=acct_name%>&month=10&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m10)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m11)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs1.getString("i_acctno"))%>&acct_desc=<%=acct_name%>&month=11&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m11)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m12)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs1.getString("i_acctno"))%>&acct_desc=<%=acct_name%>&month=12&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m12)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_sm1)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs1.getString("i_acctno"))%>&acct_desc=<%=acct_name%>&month=Q1&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_sm1)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_sm2)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs1.getString("i_acctno"))%>&acct_desc=<%=acct_name%>&month=Q2&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_sm2)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m13)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="EIS_AllPvdExpenceMonthDetail.jsp?i_company=<%=i_com%>&i_project=<%=i_proj%>&acctno=<%=doString.checkString(rs1.getString("i_acctno"))%>&acct_desc=<%=acct_name%>&month=ALL&year=<%=year%>"><% } %><%=doString.displayNumber("###,###.0", b_m13)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", a_per1)%></td>
      <td width="50px"><%=doString.displayNumber("###,###.0", b_per1)%></td>
    </tr>
<%
...
<%
		 ...
		 //  out.println(sql.toString());
			...
			while (rs1.next()) {			
						...
						sql.delete(0, sql.length());
						sql.append("select sum(a.z_amount) as z_amount from lan:acxgldtl a ")
						     .append("where year(a.doc_date)+543 < '"+year+"' ");   
				if (project.equals("LHALL")) {
								sql.append("and not exists (select b.i_company, b.i_project from lan:serv_local b where a.comp_id = b.i_company and a.department = b.i_project) ");
				} else {
...
<%
						sql.delete(0, sql.length());
						sql.append("select sum(a.z_amount_bf+a.z_amount_inv) as z_amount from lan:acbinfbf a ")
							.append("where a.i_year = '"+year+"' ");   
				if (project.equals("LHALL")) {
						sql.append("and not exists (select b.i_company, b.i_project from lan:serv_local b where a.i_company = b.i_company and a.i_project = b.i_project) ");
				} else {
						...
						sql.append("and a.i_code = '090' ")
							.append("and a.i_detail1 = '015' ");
						rs2 = stmt2.executeQuery(sql.toString());
						if (rs2.next()) {		
						...
						sql.delete(0, sql.length());
						sql.append("select sum(a.z_amount) as z_amount from lan:acbcasfd a ")                                              
							.append("where a.i_year = '"+year+"' ");                                                      
				if (project.equals("LHALL")) {
						sql.append("and not exists (select b.i_company, b.i_project from lan:serv_local b where a.i_company = b.i_company and a.i_project = b.i_project) ");
				} else {
						sql.append("and a.i_company = '"+i_com+"' ")                                        
							...
							sql.append("and a.i_bud_type = '1' ")                                                            
							.append("and a.i_code = '090' ")                                                              
							.append("and a.i_detail = '015' ");
						rs2 = stmt2.executeQuery(sql.toString());
						if (rs2.next()) {		
...
<%
	...
	System.out.println("!!!ERROR EIS_ServAllProjExpenceMnt.jsp : " + e.getMessage());
	System.out.println("!!!ERROR EIS_ServAllProjExpenceMnt.jsp SQL : " + sql.toString());
