 ...
 * @author
 */
public class SERV_Conf_RetRetenServlet extends DBServlet  {
...
/*
		...
		try {
		   ...
		   sql.delete(0,sql.length());
				   ...
				   if (approveFlag.equalsIgnoreCase("G")) {	      
						sql.append(" i_doc_status='G' ,  ")
							  .append(" i_cur_apprv='").append(iCurApprove).append("'  ");					       		
			       } else {
						sql.append(" i_doc_status='R' ,  ")
			       ...
			       //-----================== Insert new Flow for this document ===============-----//
					...
					sql.append(" insert into lan:serv_apprv (i_flow,i_docno,i_doc_status,i_apprv,d_apprv,c_apprv) ")
						  ...
						  .append(" '").append(approveFlag.equalsIgnoreCase("G") ? "G" : "R").append("' , ")
					...
					if (approveFlag.equalsIgnoreCase("G")) {
						...
						if (rs.next()) {
							...
							if (email.trim().length()>0) {
								...
								String url = Constants.APP_SERVER+Constants.APP_PATH+"/SERV_Conf_RetReten2.jsp?i_docno="+iDocNo+"&user_who="+userWho;
