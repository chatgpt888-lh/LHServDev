 ...
 * Last modify :2013.07.25 by  add criteria select multiple project& massage please wait.
 * version :1.0
...
<HTML>
<HEAD>
<TITLE>Print Carbon Password (Customer)</TITLE>
	 ...
	 if(document.forms[0].lock1.value!="" || document.forms[0].lock2.value!=""
			...
			if(document.forms[0].projSelDDL.options.length>1 || document.forms[0].projSelDDL.value=='AA:999'){
			   ...
			   return;
				...
				document.forms[0].dayDDL1.value = "";
     			document.forms[0].mmDDL1.value = "";
     			document.forms[0].yyDDL1.value = "";
    	 		document.forms[0].dayDDL2.value = "";
     			document.forms[0].mmDDL2.value = "";
     			document.forms[0].yyDDL2.value = "";
     			
			     do_totals1();
				 document.forms[0].multiFlag.value = 0;
				 document.forms[0].action="<%=request.getContextPath()%>/ESERV_PrintPwdOldCustServlet?cmd=gen";
	 	...
	 	if(document.forms[0].projSelDDL.value=='AA:999'){
			...
			||document.forms[0].lock5.value!="" ){
			    ...
			    if(validDate()){//validate date
					...
					if(dateDiff>31 ){
					//if(2==1){
						alert("กรุณาตรวจสอบวันที่ด้วย เนื่องจากเกิน 1 เดือน.");
    ...
    <td width="100%" class="BD" >   
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          ...
          &nbsp;Print Carbon Password (Customer)</td>
        </tr>
      </table>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <td height="22" width="82%" class="dotline01" colspan="2" align="center">
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
        ...
        <tr>
          <td class="dotline" align="right" width="45%" rowspan="6" style="padding:15px 0px 15px 0px">
          ...
          <td align="left" class="dotline" width="45%" rowspan="6" style="padding:15px 0px 15px 0px">
    ...
    <tr>
    <td class="item ; dotline01" height="22" width="18%">กรณีระบุแปลง :</td>
    <td height="22" width="82%" class="dotline01">
  	<br style="font-size:2pt">1.<input type="text" name="lock1" value="" size="10" maxlength="5">
...
<br style="font-size:10pt">
        <table border="0" width="100%" cellspacing="0" cellpadding="0" height="30">
          <tr>
            ...
            <a href="#" onclick="javascript:doGenpassword();"><img border="0" src="images/act_print.gif"                                   
