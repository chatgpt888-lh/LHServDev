...
$(document).ready(function(){
    $("#uploadbutton").click(function (e){
    	...
    	//if(checkFileExt()){
	    	onPleaseWait();
	        doSubmitForm("<%=request.getContextPath()%>/upload2_progress.jsp");	
        //}
    });
});
function onPleaseWait(){
	document.all.pleasewaitScreen.style.pixelTop = (document.body.scrollTop + 80);
	$('#pleasewaitScreen').show();
	setTimeout(function(){  $('#pleasewaitScreen').css("visibility", 'hidden'); }, 30000); //wait 3 seconds
...
<!--
onsubmit="if (checkFileExt()) startupload(); else return false; "
...
<!-- ########################################## -->
<DIV ID="pleasewaitScreen" STYLE="position: absolute; z-index: 0; top: 30%; left: 25%; display: none;">
