...
<%
   ...
   /*	System.out.println("**************** SERV_Manager_Conf.jsp ***************************");
...
String jName = "SERV_Manager_Conf.jsp";
   ...
   if (SERV_CommonData.checkPermissionOnPage(Constants.PERMISSION_MANAGER,user.getUserWho())) {
	...
	try {
	   ...
	   //---=========================================================================----//   
        ...
        int maxRow = 0;
		sql.delete(0,sql.length());
		sql.append(" select count(*) from serv_payment b,serv_dochd a where b.f_itmstatus='600' and a.f_status='OPN' ")
...
<!--
  ...
  function searchDocHD() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_Manager_Conf.jsp";
     ...
     if (show!=null) {
		...
		if (obj.checked) {
		      ...
		      if (html==null || html.length==0) {  
		          ...
		          html += '<textarea name="'+obj.value+'_comment" id="comment_'+obj.value.replace(":","_")+'" rows="4" class="box" style="width:100%;" cols="20"></textarea>';
		          html += '</td></tr></table>';
		          html += '<table border="0" width="100%" cellspacing="0" cellpadding="0">';
  ...
  function approve_job() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_ManagerConfServlet";
     document.forms[0].submit();
  }  
  ...
  function reject_job(){
      ...
      if (confirm("คุณแน่ใจว่าต้องการ Reject ใบงานที่เลือกนี้ ?")) {
      	  ...
      	  $('input[type=checkbox]:checked').each(function () {
			   ...
			   var chkId = $("#comment_"+status.replace(":","_"));
			   if(chkId.val()==''){
			        alert(" กรุณากรอกหมายเหตุ เกี่ยวกับการ Reject ! เลขที่อ้างอิง :"+status);
					chkId.focus();
					count++;
					return false;					     
			   }
  ...
  function routeback_job(){
      ...
      if (confirm("คุณแน่ใจว่าต้องการ RouteBack ใบงานที่เลือกนี้ ?")) {
      	  ...
      	  $('input[type=checkbox]:checked').each(function () {
			   ...
			   var chkId = $("#comment_"+status.replace(":","_"));
			   if(chkId.val()==''){
			        alert(" กรุณากรอกหมายเหตุ เกี่ยวกับการ RouteBack ! เลขที่อ้างอิง :"+status);
					chkId.focus();
					count++;
					return false;					     
			   }
		        ...
		        for (int i=0;i<maxRow;i++) { 
                      if (rs.next()) {
                         if (i>=startRow && i<=endRow) {
				            ...
				            cutType = doString.checkString(doString.DisplayThai(rs.getString("n_desc")),"");
								    ...
								    <td width="100%" class="frmL">
								      ...
								      <table border="0" width="100%" cellspacing="0" cellpadding="0">
								        <tr>
								          ...
								          <td rowspan="2" class="col_nameS" width="7%">รวมค่าดำเนิน<br>การ <%=markupPay%></td>
								        </tr>
								        <tr>
							...
							while (rs1.next()) {
							    ...
							    fContr = doString.checkString(doString.DisplayThai(rs1.getString("f_contr")),"N");
...
<br style="font-size:10pt">
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" height="30">
          <tr>
	           ...
	           <%
	            ...
	            // &comId=LH&projId=075	             
	             ...
	             if(!"".equals(comId) && !"".equals(projId)){
	                 param = "sel_project="+comId+":"+projId;
	             }else{
	                 param = "sel_project="+selProj;
	             }  
            ...
            <td class="act_tab4"><a href="<%=Constants.APP_PATH%>/SERV_Manager_List.jsp" target="_self"><img border="0" src="images/bu_back.gif" align="absmiddle" width="50" height="15"></a>&nbsp;
              <a href="<%=request.getContextPath()%>/SERV_Home.jsp?<%=param %>" target="_top"><img border="0" src="images/bu_home.gif" align="absmiddle" width="50" height="15"></a></td>  
          </tr>   
        </table>  
...
<%    System.out.println("-------- SERV_Manager_Conf.jsp -------");
		...
		System.out.println("ERROR SERV_Manager_Conf.jsp : " + e.getMessage());
