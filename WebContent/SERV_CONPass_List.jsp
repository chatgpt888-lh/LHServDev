...
<%
   ...
   if  (selProj.length()==0) {
	...
	//---==============================================================================----//
        ...
        int maxRow = 0;
        sql.delete(0,sql.length());
        sql.append(" select count(*) from lan:serv_infpayment b,serv_infdochd a where ")
              .append(" b.i_docno=a.i_docno and a.f_status in ('OPN','CLS') ")
              .append(" and b.f_itmstatus='CLS' ").append(condition).append(itmType_restrict)                   
...
<!--
  ...
  function searchDocHD() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_CONPass_List.jsp";
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <table border="0" width="140" cellspacing="0" cellpadding="0">
              <tr>
                <td width="100%" class="TextMenu"><a href="SERV_CONPass_Full.jsp?itmType=<%=itmType%>&sel_project=<%=selProj%>&d_payment=<%=dPayment%>&i_vendor=<%=iVendor%>"><img border="0" src="images/i_arrow1.gif" align="absmiddle" width="15" height="15">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" class="frmL">
              ...
              <table border="0" width="100%" cellspacing="0" cellpadding="0">
                <tr> 
                  <td class="col_name" width="17%" rowspan="2">เลขที่ใบเบิกงวด</td>
		        ...
		        for (int i=0;i<maxRow;i++) { 
                      if (rs.next()) {
                         if (i>=startRow && i<endRow) {
							...
							//---============ Find Vendor Cut ==============---//
							sql.delete(0,sql.length());
							sql.append(" select b.i_docno,p_cut,sum(z_cut_pv) sum_cut_pv from lan:serv_infdochd a, lan:serv_infpayment b ")
							      .append(" where b.i_docno=a.i_docno and a.f_status='OPN' and b.f_itmstatus='CLS' ")
...
<br style="font-size:10pt">
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" height="30">
          <tr>
            ...
            <td class="act_tab4"><a href="SERV_Index.jsp" target="_top"><img border="0" src="images/bu_back.gif" align="absmiddle" width="50" height="15"></a>&nbsp;
...
<%
		...
		System.out.println("ERROR SERV_CONPass_List.jsp : " + e.getMessage());
