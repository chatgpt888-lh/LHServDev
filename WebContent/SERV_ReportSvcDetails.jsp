 ...
 * date time: 2017.07.26 , 2015.10.06
 * Last modify :
 * version :1.0
 * project Name : LHSERV
...
//output: 07/10/2558
	...
	public static  String toDDMMYY_THAI1(String str){
		if ((str == null) || str.equals("")) {
			 return  str;
		}else{
		     String x = str.substring(0,10);
...
String COLUMN_COUNT_DATE[] = new String[] {"0","90","180","270","360","450","720","1080","1440","1800","2160","2520","2880","3240","3600","> 3600"};
...
//DecimalFormat  format2 = new DecimalFormat("#,###,##0.0");
  ...
  String transMonth = request.getAttribute("transMonth")==null?"0":(String)request.getAttribute("transMonth");//1,2,3,4
...
<script language="javascript">
	...
	function doSubmit(){
		...
		document.forms[0].action="<%=request.getContextPath()%>/SERV_ReportSvcServlet?cmd=Desc";
	    document.forms[0].submit();
	    //alert(document.forms[0].action);
	}
	
	function doExport(){
		document.forms[0].action="<%=request.getContextPath()%>/SERV_ReportSvcServlet?cmd=Desc&export2Excel=Y";
	    document.forms[0].submit();
	    //alert(document.forms[0].action);
	}
...
<input type="hidden" name="transMonth" value="<%=transMonth %>">
    ...
    <td width="100%" class="BD" >
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
           ...
           &nbsp;รายงานฐานการรับสายตามช่วงโอน</td>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    ...
    &nbsp;ระหว่างวันที่ : <font color="#0078ff"> <%=arrFromThaiDate[0] %> <%=thaiMonth[Integer.parseInt(arrFromThaiDate[1])]%> &nbsp; พ.ศ. <%=arrFromThaiDate[2]%> &nbsp; &nbsp; ถึง
    <%=arrToThaiDate[0] %> <%=thaiMonth[Integer.parseInt(arrToThaiDate[1])]%> &nbsp; พ.ศ. <%=arrToThaiDate[2]%></font> </td>
  </tr>
  <tr>
    <td class="item ; dotline01" height="22" colspan="4" align="left">
  ...
  <tr>
    <td class="item ; dotline01" height="22" colspan="4" align="left">
    &nbsp;ตามช่วงโอน :  <font color="#0078ff"> <%=COLUMN_HD1[Integer.parseInt(transMonth)] %>  &nbsp;&nbsp;&nbsp;( &nbsp;<%=COLUMN_COUNT_DATE[Integer.parseInt(transMonth)] %> &nbsp; วัน)
    </font></td>
  </tr>
  <%} %>
...
<BR style="FONT-SIZE: 10pt">
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td class="item_tab2" width="160">รายละเอียดรายงานฐานการรับสายตามช่วงโอน</td>
                <td class="item_tab3"></td>
                <td align="right">&nbsp;
    ...
    <td width="100%" class="frmL">
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="%" class="col_name">วันที่โอน</td>
	        ...
	        while(itHD.hasNext()){
	    	   ...
	    	   c++;
		        ...
		        <tr height="18px" <%=tagColor %>>
		          <td class="dotline ; item" nowrap="nowrap"><%=loop%></td>
		          ...
		          <td  align="left"  class="dotline ; item" nowrap="nowrap"><%=toDDMMYY_THAI1(strList.get(19).toString())%>&nbsp;</td>
		...
		<%     loop++;
        	...
        	%>
				<tr align="left" > 
                       <td  height="22"  align="center" colspan="15" class="side01" >***ไม่มีข้อมูล***</td>
                </tr>
       <% 	
        }
		%>        	        		                                                          
