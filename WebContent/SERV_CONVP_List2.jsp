...
<!--
  ...
  function searchDocHD() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_CONVP_List2.jsp";
...
<input type="hidden" name="success_page" value="SERV_CONVP_List2.jsp?itmType=<%=itmType%>&d_payment=<%=dPayment%>&i_company=<%=iCompany%>">
<input type="hidden" name="error_page" value="SERV_CONVP_List2.jsp?error=1&itmType=<%=itmType%>&d_payment=<%=dPayment%>&i_company=<%=iCompany%>">
                      ...
                      while (rs.next()) {
					        ...
					        %>
							  <tr>
							    ...
							    <td width="30%" class="dotline" align="left"><a href="SERV_CONVP_List3.jsp?itmType=<%=itmType%>&sel_project=<%=iCompany+":"+iProject%>&d_payment=<%=dPayment%>"><%=iCompany+"-"+iProject%> <%=proejectName%></a></td>
...
<br style="font-size:10pt">
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" height="30">
          <tr>
            ...
            <td class="act_tab4"><a href="<%=Constants.APP_PATH%>/SERV_CONVP_List.jsp?itmType=<%=itmType%>&sel_project=<%=selProj%>&d_payment=<%=dPayment%>" target="_self"><img border="0" src="images/bu_back.gif" align="absmiddle" width="50" height="15"></a>&nbsp;
...
<%
		...
		System.out.println("ERROR SERV_CONVP_List2.jsp : " + e.getMessage());
