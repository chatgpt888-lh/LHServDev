...
<!--
  function PrintLetter(frm) {
     frm.target = "_blank";
     //frm.action = "/LHServ/PrintInfLetter5Servlet";
	 frm.action = "https://www7.lh.co.th/LHServ/PrintInfLetter5Servlet";
     frm.submit();
     frm.target = "_self";       
  }
...
<FORM NAME="frmLetter" METHOD=POST ACTION="/LHServ/PrintInfLetter5Servlet">
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				<td width="50%" class="bigh"><img border="0"
					src="images/i_home.gif" align="absmiddle" width="20" height="20">&nbsp;จดหมายงดให้บริการจัดเก็บขยะครัวเรือน</td>
...
%>
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td class="item_tab2" width="250">จดหมายงดให้บริการจัดเก็บขยะครัวเรือน</td>
...
<!-- 					
					<tr>					
                  <td class="item ; dotline01" height="22" width="11%">ชำระเงินภายในวันที่ :</td>
...
<%
		...
		System.out.println("ERROR SERV_PrintInfLetter5.jsp : " + e.getMessage());
