...
<!--
  ...
  function viewDetail(acctno , acctdesc ,  month  , year) {
	 document.forms[0].acctNoDetail.value=acctno;
	 document.forms[0].acctDescDetail.value=acctdesc;
	 document.forms[0].monthDetail.value=month;
	 document.forms[0].yearDetail.value=year;
     document.forms[0].action="<%=Constants.APP_PATH%>/EIS_ServMultiProjExpenceMnt_Detail.jsp";
...
<input type="hidden" name="acctNoDetail" >
<input type="hidden" name="acctDescDetail" >
<input type="hidden" name="monthDetail" >
<input type="hidden" name="yearDetail" >
...
<br style="font-size:8pt">
  ...
  <%
	  ...
	  if (projList!=null) {
		  for (int i=0;i<projList.length;i++) {
				...
				while (rs.next()) {
				    ...
				    %><td height="22" width="25%" class="dotline01"><%=iProj%> <%=nProject%></td><%
		  ...
		  while (line%3!=0) {
			  %><td height="22" width="25%" class="dotline01">&nbsp;</td><%
			  line++;
     ...
     <tr>
      <td class="item : 10pt" height="28" bgcolor="#F6F6F6">ประเภทค่าใช้จ่าย : </td>
      <td  height="28" bgcolor="#F6F6F6">&nbsp;<select size="1" name="typecost" class="box" style="width:180px" disabled>
...
<td  class="item : 10pt" height="28" bgcolor="#F6F6F6">ค่าใช้จ่ายฝ่าย/กลุ่ม :&nbsp;&nbsp;<SELECT size="1" name="dept" class="box" style="width:80px"  disabled> 
      ...
      <td  height="28" bgcolor="#F6F6F6"  class="item : 10pt" > ประจำปี : <SELECT size="1" name="dept" class="box" style="width:80px"  disabled> 
...
<%
		...
		if (typecost.equals("A")) {
				type_id = "= '1'";
				btype_id = "= '1'";
				sum_detail = "sum(z_expst_m1) m1, sum(z_expst_m2) m2, sum(z_expst_m3) m3, sum(z_expst_m4) m4, sum(z_expst_m5) m5, ";
				sum_detail += "sum(z_expst_m6) m6, sum(z_expst_m7) m7, sum(z_expst_m8) m8, sum(z_expst_m9) m9, sum(z_expst_m10) m10, ";
				sum_detail += "sum(z_expst_m11) m11, sum(z_expst_m12) m12, sum(z_expst_m13) m13, ";
				sum_detail += "sum(z_expst_m1+z_expst_m2+z_expst_m3+z_expst_m4+z_expst_m5+z_expst_m6) sm1, sum(z_expst_m7+z_expst_m8+z_expst_m9+z_expst_m10+z_expst_m11+z_expst_m12) sm2";

				Bsum_detail = "sum(z_bugst_m1) m1, sum(z_bugst_m2) m2, sum(z_bugst_m3) m3, sum(z_bugst_m4) m4, sum(z_bugst_m5) m5, ";
				Bsum_detail += "sum(z_bugst_m6) m6, sum(z_bugst_m7) m7, sum(z_bugst_m8) m8, sum(z_bugst_m9) m9, sum(z_bugst_m10) m10, ";
				Bsum_detail += "sum(z_bugst_m11) m11, sum(z_bugst_m12) m12, sum(z_bugst_m13) m13, ";
				Bsum_detail += "sum(z_bugst_m1+z_bugst_m2+z_bugst_m3+z_bugst_m4+z_bugst_m5+z_bugst_m6) sm1, sum(z_bugst_m7+z_bugst_m8+z_bugst_m9+z_bugst_m10+z_bugst_m11+z_bugst_m12) sm2";
		
		} else if (typecost.equals("B")) { 
				type_id = "= '1'";
				btype_id = "= '1'";
				sum_detail = "sum(z_expal_m1) m1, sum(z_expal_m2) m2, sum(z_expal_m3) m3, sum(z_expal_m4) m4, sum(z_expal_m5) m5, ";
				sum_detail += "sum(z_expal_m6) m6, sum(z_expal_m7) m7, sum(z_expal_m8) m8, sum(z_expal_m9) m9, sum(z_expal_m10) m10, ";
				sum_detail += "sum(z_expal_m11) m11, sum(z_expal_m12) m12, sum(z_expal_m13) m13, ";
				sum_detail += "sum(z_expal_m1+z_expal_m2+z_expal_m3+z_expal_m4+z_expal_m5+z_expal_m6) sm1, sum(z_expal_m7+z_expal_m8+z_expal_m9+z_expal_m10+z_expal_m11+z_expal_m12) sm2";

				Bsum_detail = "sum(z_bugal_m1) m1, sum(z_bugal_m2) m2,sum(z_bugal_m3) m3, sum(z_bugal_m4) m4, sum(z_bugal_m5) m5, ";
				Bsum_detail += "sum(z_bugal_m6) m6, sum(z_bugal_m7) m7, sum(z_bugal_m8) m8, sum(z_bugal_m9) m9, sum(z_bugal_m10) m10, ";
				Bsum_detail += "sum(z_bugal_m11) m11, sum(z_bugal_m12) m12, sum(z_bugal_m13) m13, ";
				Bsum_detail += "sum(z_bugal_m1+z_bugal_m2+z_bugal_m3+z_bugal_m4+z_bugal_m5+z_bugal_m6) sm1, sum(z_bugal_m7+z_bugal_m8+z_bugal_m9+z_bugal_m10+z_bugal_m11+z_bugal_m12) sm2";
				...
				type_id = "= '1'";
				btype_id = "= '1'";
				sum_detail = "sum(z_expst_m1+z_expal_m1) m1, sum(z_expst_m2+z_expal_m2) m2, sum(z_expst_m3+z_expal_m3) m3, sum(z_expst_m4+z_expal_m4) m4, sum(z_expst_m5+z_expal_m5) m5, ";
				sum_detail += "sum(z_expst_m6+z_expal_m6) m6, sum(z_expst_m7+z_expal_m7) m7, sum(z_expst_m8+z_expal_m8) m8, sum(z_expst_m9+z_expal_m9) m9, sum(z_expst_m10+z_expal_m10) m10, ";
				sum_detail += "sum(z_expst_m11+z_expal_m11) m11, sum(z_expst_m12+z_expal_m12) m12, sum(z_expst_m13+z_expal_m13) m13, ";
				sum_detail += "sum(z_expst_m1+z_expal_m1+z_expst_m2+z_expal_m2+z_expst_m3+z_expal_m3+z_expst_m4+z_expal_m4+z_expst_m5+z_expal_m5+z_expst_m6+z_expal_m6) sm1, ";
				sum_detail += "sum(z_expst_m7+z_expal_m7+z_expst_m8+z_expal_m8+z_expst_m9+z_expal_m9+z_expst_m10+z_expal_m10+z_expst_m11+z_expal_m11+z_expst_m12+z_expal_m12) sm2";

				Bsum_detail = "sum(z_bugst_m1+z_bugal_m1) m1, sum(z_bugst_m2+z_bugal_m2) m2, sum(z_bugst_m3+z_bugal_m3) m3, sum(z_bugst_m4+z_bugal_m4) m4, sum(z_bugst_m5+z_bugal_m5) m5, ";
				Bsum_detail += "sum(z_bugst_m6+z_bugal_m6) m6, sum(z_bugst_m7+z_bugal_m7) m7, sum(z_bugst_m8+z_bugal_m8) m8, sum(z_bugst_m9+z_bugal_m9) m9, sum(z_bugst_m10+z_bugal_m10) m10, ";
				Bsum_detail += "sum(z_bugst_m11+z_bugal_m11) m11, sum(z_bugst_m12+z_bugal_m12) m12, sum(z_bugst_m13+z_bugal_m13) m13, ";
				Bsum_detail += "sum(z_bugst_m1+z_bugal_m1+z_bugst_m2+z_bugal_m2+z_bugst_m3+z_bugal_m3+z_bugst_m4+z_bugal_m4+z_bugst_m5+z_bugal_m5+z_bugst_m6+z_bugal_m6) sm1, ";
				Bsum_detail += "sum(z_bugst_m7+z_bugal_m7+z_bugst_m8+z_bugal_m8+z_bugst_m9+z_bugal_m9+z_bugst_m10+z_bugal_m10+z_bugst_m11+z_bugal_m11+z_bugst_m12+z_bugal_m12) sm2";
			 ...
			 //---------------------- Calculate % ---------------------
			  z_net_ytd = 0;
			  sql.delete(0, sql.length());
			  sql.append("select sum(z_net_ytd/1000) as z_net_ytd from lan:acmycost ")
			  	 .append("where  ")
...
%>
     <tr class="col_right ; specH1 ; white">
      ...
      <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','01','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m1)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m2)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','02','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m2)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m3)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','03','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m3)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m4)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','04','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m4)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m5)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','05','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m5)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m6)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','06','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m6)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m7)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','07','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m7)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m8)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','08','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m8)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m9)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','09','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m9)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m10)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','10','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m10)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m11)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','11','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m11)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m12)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','12','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m12)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_sm1)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','Q1','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_sm1)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_sm2)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','Q2','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_sm2)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m13)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','ALL','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m13)%></A></td>
...
if (typecost.equals("C") || typecost.equals("E")) {
				b_m1 = 0; b_m2 = 0;b_m3 = 0;b_m4 = 0;b_m5 = 0;b_m6 = 0;b_m7 = 0;b_m8 = 0;b_m9 = 0;b_m10 = 0;b_m11 = 0;b_m12 = 0;b_m13 = 0;b_sm1 = 0;b_sm2 = 0;
				 ...
				 .append("  AND (").append(queryProject).append(") ")
...
%>
  <tr class="col_right ; specH1 ; white">
	  ...
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m1)%></td>
      <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','01','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m1)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m2)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','02','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m2)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m3)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','03','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m3)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m4)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','04','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m4)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m5)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','05','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m5)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m6)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','06','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m6)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m7)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','07','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m7)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m8)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','08','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m8)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m9)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','09','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m9)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m10)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','10','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m10)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m11)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','11','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m11)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m12)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','12','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m12)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_sm1)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','Q1','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_sm1)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_sm2)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','Q2','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_sm2)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m13)%></td>
	  <td width="50px"><% if (chk_link.equals("Y") && !monthly.equals("(monthly)")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs.getString("i_acctno"))%>','<%=acct_desc%>','ALL','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m13)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", a_per1)%></td>
      <td width="50px"><%=doString.displayNumber("###,###.0", b_per1)%></td>
    </tr>
...
sql.append("select sum(z_amount) as z_amount, month(doc_date) as mnt_cash from lan:acxgldtl ")
	 .append("where  ")
	.append("  (").append(queryProjectComId).append(") ")
...
<tr class="col_right ; specH1 ; white">
	  ...
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m1)%></td>
      <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs1.getString("i_acctno"))%>','<%=acct_desc%>','01','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m1)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m2)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs1.getString("i_acctno"))%>','<%=acct_desc%>','02','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m2)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m3)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs1.getString("i_acctno"))%>','<%=acct_desc%>','03','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m3)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m4)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs1.getString("i_acctno"))%>','<%=acct_desc%>','04','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m4)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m5)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs1.getString("i_acctno"))%>','<%=acct_desc%>','05','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m5)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m6)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs1.getString("i_acctno"))%>','<%=acct_desc%>','06','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m6)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m7)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs1.getString("i_acctno"))%>','<%=acct_desc%>','07','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m7)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m8)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs1.getString("i_acctno"))%>','<%=acct_desc%>','08','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m8)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m9)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs1.getString("i_acctno"))%>','<%=acct_desc%>','09','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m9)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m10)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs1.getString("i_acctno"))%>','<%=acct_desc%>','10','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m10)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m11)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs1.getString("i_acctno"))%>','<%=acct_desc%>','11','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m11)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m12)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs1.getString("i_acctno"))%>','<%=acct_desc%>','12','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m12)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_sm1)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs1.getString("i_acctno"))%>','<%=acct_desc%>','Q1','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_sm1)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_sm2)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs1.getString("i_acctno"))%>','<%=acct_desc%>','Q2','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_sm2)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", v_m13)%></td>
	  <td width="50px"><% if (chk_link.equals("Y")) {  %><A HREF="javascript:viewDetail('<%=doString.checkString(rs1.getString("i_acctno"))%>','<%=acct_desc%>','ALL','<%=year%>')"><% } %><%=doString.displayNumber("###,###.0", b_m13)%></A></td>
	  <td width="50px" bgcolor="#FFFFCC"><%=doString.displayNumber("###,###.0", a_per1)%></td>
      <td width="50px"><%=doString.displayNumber("###,###.0", b_per1)%></td>
    </tr>
<%
