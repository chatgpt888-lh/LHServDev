...
<!--
  ...
  function goReport() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_INFReport10_1.jsp";
...
<FORM ACTION="SERV_INFReport10.jsp" METHOD="POST" name="frm">
...
<%
		...
		if (nowYear>2400) nowYear -= 543;
         out.println(common.genYearListbox("year_report",""," class='box' ",2007,(nowYear-2007)+1));
%>	
				 </td>
              </tr>
              <tr> 
...
<%
		...
		System.out.println("ERROR SERV_INFReport10.jsp : " + e.getMessage());
