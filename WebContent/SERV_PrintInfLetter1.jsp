...
<!--
  function PrintLetter(frm) {
	 frm.target = "_blank";
	 frm.action = "https://www7.lh.co.th/LHServ/PrintInfLetter1Servlet";
	 //frm.action = "/LHServ/PrintInfLetter1Servlet";
     frm.submit();
	 frm.target = "_self";
  }
//-->
...
<FORM NAME="frmLetter" METHOD=POST ACTION="/LHServ/PrintInfLetter1Servlet">
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				<td width="50%" class="bigh"><img border="0"
					src="images/i_home.gif" align="absmiddle" width="20" height="20">&nbsp;จดหมายแจ้งการจัดเก็บค่าบริการสาธารณะประจำปี</td>
...
String year = Integer.toString(Integer.parseInt(cur_year)-543);
...
%>
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td class="item_tab2" width="270">จดหมายแจ้งการจัดเก็บค่าบริการสาธารณะประจำปี</td>
...
%>                                          
                  ...
                  <td height="22" class="dotline01" width="80%">
			<select size="1" name="inf_year" class="box" style="width:80px">
<%
...
%> 
					...
					<tr>
                  <td class="item ; dotline01" height="22" width="20%">ลงวันที่ :</td>
                  <td height="22" class="dotline01" width="80%"><%date_util.printHtmlThaiDateNoTime(out, "Prnt", "", 5, 2, "white", "#0078FF");%></td>
					</tr>
					<tr>
                  <td class="item ; dotline01" height="22" width="20%">วันที่้สิ้นสุดระยะเวลา<br>การให้บริการ
                    :</td>
                  <td height="22" class="dotline01" width="80%"><%date_util.printHtmlThaiDateNoTime(out, "Finish", "", 5, 2, "white", "#0078FF");%></td>
					</tr>
					<tr>	
					<tr>
                  <td class="item ; dotline01" height="22" width="20%">วันที่เริ่มดำเนินการจัดเก็บล่วงหน้า :</td>
                  <td height="22" class="dotline01" width="80%">
                  <%date_util.printHtmlThaiDateNoTime(out, "Start", beg_date, 5, 2, "white", "#0078FF");%>&nbsp;ถึง&nbsp;
                  <%date_util.printHtmlThaiDateNoTime(out, "Stop", end_date, 5, 2, "white", "#0078FF");%>                  
                  </td>
					</tr>
					<tr>										
                  <td class="item ; dotline01" height="22" width="20%">ชื่อผู้ติดต่อ :</td>
                  <td height="22" class="dotline01" width="80%"><input type="text" name="Contact" class="box" style="width:250px" value="Service Center"></td>
					</tr>										
					<tr>					
                  <td class="item ; dotline01" height="22" width="20%">เบอร์โทรศัพท์ :</td>
                  <td height="22" class="dotline01" width="80%"><input type="text" name="Phone" class="box" style="width:250px" value="1198 กด 2"></td>
					</tr>						
				</table>
				</td>
			</tr>
...
<%
		...
		System.out.println("ERROR SERV_PrintInfLetter1.jsp : " + e.getMessage());
