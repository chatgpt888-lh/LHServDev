...
<!--
  ...
  function searchDocHD() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_INFZone_Conf_Full.jsp";
...
<FORM METHOD="POST" ACTION="">
    ...
    <input type="hidden" name="success_page" value="SERV_INFZone_Conf_Full.jsp?itmType=<%=itmType%>&i_vendor=<%=iVendor%>">
    <input type="hidden" name="error_page" value="SERV_INFZone_Conf_Full.jsp?error=1&itmType=<%=itmType%>&i_vendor=<%=iVendor%>">    
      ...
      <td width="50%" class="bigh"><img border="0" src="images/i_home.gif" align="absmiddle" width="20" height="20">&nbsp; 
        Manager - ผู้จัดการกลุ่ม</td>
          ...
          <table border="0" width="140" cellspacing="0" cellpadding="0">
            ...
            <td width="100%" class="TextMenu"><a href="SERV_INFZone_Conf.jsp?itmType=<%=itmType%>&i_vendor=<%=iVendor%>"><img border="0" src="images/i_arrow1.gif" align="absmiddle" width="15" height="15"> 
              แสดงแบบสรุป</a></td>
              </tr>
          </table>    
			</td>
...
<%
      ...
      <td class="item_tab1">
					                ...
					                <td class="item_tab2" width="100">
									<%=iDocNo%></td>
					                <td class="item_tab3"></td>
					                
      <td class="textgray">&nbsp;&nbsp; เลขที่ใบสั่งซ่อม 
        : <a href="SERV_INFOpenJob_Pay_Disp.jsp?i_docno=<%=iDocNo%>&popup=y&edit=no" target="_blank"><%=iDocNo%></a> 
      </td>                
					              </tr>
					            </table>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td rowspan="2" class="col_nameS">&nbsp;</td>
          ...
          <tr> 
            ...
            <td class="dotline" align="center" width="3%" valign="top">&nbsp;</td>
            ...
            <td class="dotline" align="right" width="7%" valign="top"><%=format.format(cutVendor)%></td>
							  ...
							  if (remark.length()>0) {
								  %>      
          <tr>
            <td class="dotline" width="52%" valign="top"><img border="0" src="images/bu_nextPage.gif" align="absmiddle" width="5" height="7">&nbsp; 
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            ...
            <td class="col_nameLow" width="7%">รวม</td>
								        ...
								        %>
          <tr> 
            <td class="dotline" width="52%" valign="top">&nbsp;</td>
            <td class="dotline" align="center" width="3%" valign="top">&nbsp;</td>
            <td class="dotline" align="right" width="3%" valign="top">&nbsp;</td>
            <td class="dotline" align="right" width="7%" valign="top">&nbsp;</td>
            <td class="dotline" align="right" width="7%" valign="top">&nbsp;</td>
...
<br style="font-size:10pt">
      ...
      <td class="act_tab4"><a href="SERV_INFZone_Conf.jsp?itmType=<%=itmType%>" target="_self"><img border="0" src="images/bu_back.gif" align="absmiddle" width="50" height="15"></a>&nbsp; 
...
<%
		...
		System.out.println("ERROR SERV_INFZone_Conf_Full.jsp : " + e.getMessage());
