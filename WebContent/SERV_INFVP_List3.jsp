...
<%
   ...
   if  (selProj.length()==0) {
    ...
    if (SERV_CommonData.checkPermissionOnPage(Constants.PERMISSION_VP,user.getUserWho())) {
        permission = true;
    }
	...
	try {
	   ...
	   vendorCut.addElement(new Double(percent));
        ...
        sql.append(" select count(*) from serv_infpayment b,serv_infdochd a where ")
              ...
              .append(" and b.f_itmstatus='800' ").append(condition).append(itmType_restrict)
...
<!--
  ...
  function searchDocHD() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_INFVP_List3.jsp";
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <table border="0" width="140" cellspacing="0" cellpadding="0">
              <tr>
                <td width="100%" class="TextMenu"><a href="SERV_INFVP_List4.jsp?itmType=<%=itmType%>&sel_project=<%=selProj%>&d_payment=<%=dPayment%>"><img border="0" src="images/i_arrow1.gif" align="absmiddle" width="15" height="15">
    ...
    <td width="100%" class="frmL">
              ...
              <table border="0" width="100%" cellspacing="0" cellpadding="0">
                <tr> 
                  ...
                  <td class="col_name" width="13%" rowspan="2">รวมค่า ดำเนินการ 
                    <!--%--></td>
	  ...
	  %>
			...
			if(user.getUserWho().equals("A")){ //lee admin
			   sqlB.delete(0,sqlB.length());
		        ...
		        sql.append(" select b.i_docno,sum(q_wage_unit * z_wage_price) sum_wage, ")
		              ...
		              .append(" sum(z_amount_cut) sum_amount_cut from serv_infdochd a,serv_infpayment b ")
		              .append(" where b.i_docno=a.i_docno and a.f_status='OPN' and b.f_itmstatus='800' ")
		        ...
		        for (int i=0;i<maxRow;i++) { 
                      if (rs.next()) {
                         if (i>=startRow && i<endRow) {
							...
							//---============ Find Vendor Cut ==============---//
							sql.delete(0,sql.length());
							sql.append(" select b.i_docno,p_cut,sum(z_cut_pv) sum_cut_pv from serv_infdochd a,serv_infpayment b ")
							      .append(" where b.i_docno=a.i_docno and a.f_status='OPN' and b.f_itmstatus='800'  and b.i_ven_cut<>'999999' ")
								  .append(" and a.i_company='"+(selProj.length()>=6 ? selProj.substring(0,2) : "")+"' and a.i_project='"+(selProj.length()>=6 ? selProj.substring(3,6) : "")+"' ")									.append(team_condition)
        ...
        %>        
                <tr> 
                  <td align="center" class="dotline ; item">รวมเป็นเงิน</td>
...
<br style="font-size:10pt">
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" height="30">
          <tr>
            ...
            <td class="act_tab4"><a href="<%=Constants.APP_PATH%>/SERV_INFVP_List2.jsp?itmType=<%=itmType%>&i_company=<%=selProj.length()>=2 ? selProj.substring(0,2) : ""%>&d_payment=<%=dPayment%>" target="_self"><img border="0" src="images/bu_back.gif" align="absmiddle" width="50" height="15"></a>&nbsp;
...
<%
		...
		conn=null;
			...
			System.out.println("----- SERV_INFVP_List3.jsp ----- ");
	} catch (Exception e) {
		System.out.println("ERROR SERV_INFVP_List3.jsp : " + e.getMessage());
