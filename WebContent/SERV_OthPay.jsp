...
<%@ include file="confirmLogin.jsp" %><%   	 //----============ Declare Variables for search data ===========----//	String comId = doString.checkString(request.getParameter("comId"));
    ...
    //----============ Declare Variables for data ===========----//	Connection conn = null;	Statement stmt = null;	ResultSet rs = null;	SERV_CommonData com = null;	try {        //----============ Initialize Variable ============----//		if (ds == null) getDS();		conn = ds.getConnection();		conn.setTransactionIsolation(Connection.TRANSACTION_READ_UNCOMMITTED);		conn.setAutoCommit(true);		stmt = conn.createStatement();   		com = new SERV_CommonData(conn);  
		rs = stmt.executeQuery("SELECT z_wage, z_control FROM lan:serv_othpayment WHERE i_company = '"+comId+"' AND i_project = '"+projId+"' AND i_vendor = '"+vendor+"' AND i_month = '"+mnthDate+"'");
		if (rs != null) {
			if (rs.next() == true) {
...
<BODY leftMargin=0 topMargin=0 marginheight="0" marginwidth="0"><FORM NAME="frmOthPay" METHOD=POST ACTION="/LHServ/SERV_OthPayServlet"><input type="hidden" name="mode" value="S">
...
<br style="font-size:10pt">
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0">              <tr>                <td class="item_tab1"><img border="0" src="images/i_i.gif" align="absmiddle" width="20" height="20"></td>                <td class="item_tab2" width="250">รายการเบิกงวด</td>                <td class="item_tab3"></td>                <td>&nbsp;</td>               
              </tr>
            </table>
    ...
    <td width="5" valign="bottom" align="right"><img border="0" src="images/Corn04.gif" width="5" height="5"></td>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" height="30">
          <tr>
            ...
            <td class="act_tab4"><a href="SERV_OthPayLst.jsp?sel_project=<%=comId%>:<%=projId%>&vendor=<%=vendor%>"><img border="0" src="images/bu_back.gif" align="absmiddle" width="50" height="15"></a>&nbsp;
...
<%	} catch (Exception e) {		System.out.println("ERROR SERV_OthPay.jsp : " + e.getMessage());		throw new ServletException(e.getMessage());	} finally {		// Clean up.		try {			if (rs != null) rs.close();			if (stmt != null) stmt.close();			if (conn != null) conn.close();		}		catch( SQLException ignore ){}	}%>