...
function PrintLetter(frm) {
	frm.target = "_blank";
	//frm.action = "/LHServ/PrintInfLetter8Servlet";
	frm.action = "https://www7.lh.co.th/LHServ/PrintInfLetter8Servlet";
	frm.submit();
	frm.target = "_self";
}  
//-->
...
<FORM NAME="frmLetter" METHOD=POST ACTION="/LHServ/PrintInfLetter8Servlet">
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				<td width="50%" class="bigh"><img border="0"
					src="images/i_home.gif" align="absmiddle" width="20" height="20">&nbsp;จดหมายขอให้ชำระค่าบริการสาธารณะ</td>
...
%>
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td class="item_tab2" width="300">จดหมายขอให้ชำระค่าบริการสาธารณะ</td>
...
%> 
					...
					<tr>					
                  <td class="item ; dotline01" height="22" width="11%">รอบเดือน :</td>
                  <td height="22" class="dotline01" width="89%">
...
%> 									
					...
					<tr>					
                  <td class="item ; dotline01" height="22" width="11%">ลงวันที่ :</td>
                  <td height="22" class="dotline01" width="89%"><%date_util.printHtmlThaiDateNoTime(out, "Prnt", "", 5, 2, "white", "#0078FF");%></td>
					</tr>
					
					<tr>					
                  <td class="item ; dotline01" height="22" width="11%">อ้างถึงวันที่ :</td>
                  <td height="22" class="dotline01" width="89%"><%date_util.printHtmlThaiDateNoTime(out, "Ref", "", 5, 2, "white", "#0078FF");%></td>
					</tr>
...
<%
		...
		System.out.println("ERROR SERV_PrintInfLetter8.jsp : " + e.getMessage());
