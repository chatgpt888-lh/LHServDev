...
String jName = "SERV_Report51.jsp";
...
<FORM ACTION="SERV_Report5_11.jsp" METHOD="POST" name="frm">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr> 
				...
				<%=common.genYearListbox("year_report",maxYear," class='box' ",cur_year-2,5)%>				  
				 </td>
              </tr>
              <tr> 
...
<%
		...
		System.out.println("ERROR SERV_Report51.jsp : " + e.getMessage());
