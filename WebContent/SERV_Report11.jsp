...
String jName = "SERV_Report11.jsp";
...
<!--
  ...
  function goReport() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_Report11_1.jsp";
...
<FORM ACTION="SERV_Report11_1.jsp" METHOD="POST" name="frm">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr> 
				...
				<%=common.genYearListbox("year_report",maxYear," class='box' ",minY,5)%>				  
				 </td>
              </tr>
              <tr> 
...
<%
		...
		System.out.println("ERROR SERV_Report11.jsp : " + e.getMessage());
