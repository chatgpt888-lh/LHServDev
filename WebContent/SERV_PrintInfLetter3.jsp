...
function PrintLetter(frm) {
	frm.target = "_blank";
	//frm.action = "/LHServ/PrintInfLetter3Servlet";
	frm.action = "https://www7.lh.co.th/LHServ/PrintInfLetter3Servlet";
	frm.submit();
	frm.target = "_self";
}  
//-->
...
<FORM NAME="frmLetter" METHOD=POST ACTION="/LHServ/PrintInfLetter3Servlet">
...
<!-- 											
					<tr>					
                  <td class="item ; dotline01" height="22" width="11%">วันที่สิ้นสุดระยะเวลา<br>การให้บริการ :</td>
...
<%
		...
		System.out.println("ERROR SERV_PrintInfLetter3.jsp : " + e.getMessage());
