...
<!--
  function PrintLetter(frm) {
	 frm.target = "_blank";
	 frm.action = "https://www7.lh.co.th/LHServ/PrintInfLetter7Servlet";
	 //frm.action = "/LHServ/PrintInfLetter7Servlet";
     frm.submit();
	 frm.target = "_self";
  }
//-->
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				<td width="50%" class="bigh"><img border="0"
					src="images/i_home.gif" align="absmiddle" width="20" height="20">&nbsp;จดหมายแจ้งส่ง Sticker</td>
...
%>
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td class="item_tab2" width="270">จดหมายแจ้งส่ง Sticker</td>
...
%> 
					...
					<tr>
                  <td class="item ; dotline01" height="22" width="20%">ตั้งแต่วันที่ :</td>
                  <td height="22" class="dotline01" width="80%">
...
<%
		...
		System.out.println("ERROR SERV_PrintInfLetter7.jsp : " + e.getMessage());
