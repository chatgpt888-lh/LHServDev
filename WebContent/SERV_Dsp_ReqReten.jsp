...
String jName = "SERV_Dsp_ReqReten.jsp";
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <input type="checkbox" name="f_id_card" value="Y" disabled <%=fIDCard.equalsIgnoreCase("Y") ? " checked " : ""%>>
      สำเนาบัตรประชาชน</td>
    <td height="22" class="dotline01" width="28%">&nbsp;</td>
    <td height="22" class="item ; dotline01" width="17%">วันที่คาดว่าจะรับเช็ค / PayIn
      :</td>
  ...
  <tr>
    ...
    <input type="checkbox" name="f_lose_reten" value="Y" disabled <%=fLoseReten.equalsIgnoreCase("Y") ? " checked " : ""%>>
  ...
  <tr>
    <td class="item ; dotline01" height="22" width="20%">
    <input type="checkbox" name="f_notice" value="Y" disabled <%=fNotice.equalsIgnoreCase("Y") ? " checked " : ""%>>
      ใบแจ้งความ เลขที่
      :</td>
    <td height="22" class="dotline01" width="28%">
    <input type="text" name="i_notice" class="box" maxlength="20" disabled style="width:150px" value="<%=iNotice%>"></td>
		 ...
		 Double recvReten = (Double) zReceiveReten.elementAt(i);
		  ...
		  <tr>
		    ...
		    <td height="22" class="item ; dotline01" width="17%">จำนวนเงิน
		      :</td>
		    <td height="22" class="dotline01" width="35%"><%=format.format(recvReten.doubleValue())%>&nbsp; บาท </td>
		  </tr>
		  <%  
	  } // end for
...
<br style="font-size:10pt">
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" height="30">
          <tr>
		    ...
		    <a href="<%=Constants.APP_PATH%>/SERV_PrintReqRetenServlet?i_docno=<%=iDocNo%>" target="_blank">
		    <img border="0" src="images/act_printreq.gif"
				onmouseout=nereidFade(this,70,50,5)
				onmouseover=nereidFade(this,100,50,5)
				style="FILTER: alpha(opacity=70)" width="70" height="27"></a>&nbsp;
		   <a href="<%=Constants.APP_PATH%>/SERV_Add_ReqReten.jsp?i_docno=<%=iDocNo%>&mode=edit">
