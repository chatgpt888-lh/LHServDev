...
function openUploadWindow(contextPath,sessionId,keyFile) {
	...
	vReturnValue = window.showModalDialog(contextPath+"upload_index.html",keys,"dialogHeight: 200px; dialogWidth: 400px; center: Yes; resizable: No; status: No;");
	return vReturnValue;
}