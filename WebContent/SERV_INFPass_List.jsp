...
<!--
  ...
  function searchDocHD() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_INFPass_List.jsp";
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <table border="0" width="140" cellspacing="0" cellpadding="0">
              <tr>
                <td width="100%" class="TextMenu"><a href="SERV_INFPass_Full.jsp?itmType=<%=itmType%>&sel_project=<%=selProj%>&d_payment=<%=dPayment%>&i_vendor=<%=iVendor%>"><img border="0" src="images/i_arrow1.gif" align="absmiddle" width="15" height="15">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" class="frmL">
              ...
              <table border="0" width="100%" cellspacing="0" cellpadding="0">
                <tr> 
                  <td class="col_name" width="17%" rowspan="2">เลขที่ใบสั่งซ่อม</td>
                      ...
                      if (rs.next()) {
                         if (i>=startRow && i<endRow) {
							...
							sql.append(" select b.i_docno,p_cut,sum(z_cut_pv) sum_cut_pv from lan:serv_infdochd a, lan:serv_infpayment b ")
							      .append(" where b.i_docno=a.i_docno and a.f_status='OPN' "+team_condition+" and b.f_itmstatus='CLS' ")
...
<%
		...
		System.out.println("ERROR SERV_INFPass_List.jsp : " + e.getMessage());
