...
<!--
  ...
  function searchDocHD() {
     ...
     document.forms[0].action="<%=Constants.APP_PATH%>/SERV_CONZone_Conf.jsp";
...
<input type="hidden" name="success_page" value="SERV_CONZone_Conf.jsp?itmType=<%=itmType%>&d_payment=<%=dPayment%>&i_vendor=<%=iVendor%>">
<input type="hidden" name="error_page" value="SERV_CONZone_Conf.jsp?error=1&itmType=<%=itmType%>&d_payment=<%=dPayment%>&i_vendor=<%=iVendor%>">
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <table border="0" width="140" cellspacing="0" cellpadding="0">
              <tr>
                <td width="100%" class="TextMenu"><a href="SERV_CONZone_Conf_Full.jsp?itmType=<%=itmType%>&i_vendor=<%=iVendor%>"><img border="0" src="images/i_arrow1.gif" align="absmiddle" width="15" height="15">
...
<br style="font-size:10pt">
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td class="item_tab2" width="160">รายการเบิกงวดงาน</td>
  ...
  <tr>
    <td width="100%" class="frmL">
           ...
           %>  
                  ...
                  <td class="col_name" width="15%" rowspan="2">เลขที่ใบเบิกงวด</td>
                  ...
                  <td class="col_name" width="13%" rowspan="2">รวมค่าดำเนินการ</td>
	  ...
	  %>
        ...
        <%
		     ...
		     //----================== Select Data from SERV_DOCHD ================----//   
		        ...
		        while (rs.next()) {
							...
							//---============ Find Vendor Cut ==============---//
							sql.delete(0,sql.length());
							sql.append(" select p_cut,sum(z_cut_pv) sum_cut_pv from serv_infdochd a,serv_infpayment b ")
							      .append(" where b.i_docno=a.i_docno and a.f_status='OPN' and b.f_itmstatus='700' ")
        ...
        %>        
                <tr> 
                  <td align="center" class="dotline ; item" colspan="2">รวมเป็นเงิน</td>
...
<br style="font-size:10pt">
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" height="30">
          <tr>
            ...
            <td class="act_tab4"><a href="SERV_CONZone_List.jsp?itmType=<%=itmType%>" target="_self"><img border="0" src="images/bu_back.gif" align="absmiddle" width="50" height="15"></a>&nbsp;
...
<%
		...
		System.out.println("ERROR SERV_CONZone_Conf.jsp : " + e.getMessage());
