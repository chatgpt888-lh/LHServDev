...
try {
	...
	String mth[] = {"เดือน","มกราคม","กุมภาพันธ์","มีนาคม","เมษายน","พฤษภาคม","มิถุนายน","กรกฎาคม","สิงหาคม","กันยายน","ตุลาคม","พฤศจิกายน","ธันวาคม"};
	...
	String acctno = "";
		if (request.getParameter("acctno") != null) {
		acctno = doString.checkString(request.getParameter("acctno"));
	}
	String acct_desc = "";
	if (request.getParameter("acct_desc") != null) {
		acct_desc = doString.checkString(request.getParameter("acct_desc"));
	}

	String month = "";
		if (request.getParameter("month") != null) {
		month = doString.checkString(request.getParameter("month"));
	}
	...
	String doc_desc = "", bus_name = "";
	double z_amount = 0, tot_amt = 0;

%>
<FORM NAME="frmEIS" METHOD=POST ACTION="EIS_ExpenceMonthDetail.jsp">
...
<br style="font-size:8pt">
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td class="item_tab2" width="300"><%=i_company%>-<%=i_project%> &nbsp;<%=doString.DisplayThai(doString.checkString(n_proj))%></td>
  ...
  <table border="0" width="100%" cellspacing="1" cellpadding="0">
    <tr>
      <td width="12%" class="item : 10pt" height="28">ประเภทข้อมูล :</td>
      <td width="45%" height="28"><% if (type.equals("V1")) { out.print(" ค่าใช้จ่าย"); } else if (type.equals("V2")) {out.print(" ต้นทุนทางอ้อม");} %></td>
      <td width="8%" class="item : 10pt" height="28">เดือน / ปี :</td>
      <td><% if (month.equals("Q1")){  
						out.println("Jan - Jun");
    ...
    <tr>
      <td width="12%" class="item : 10pt" height="28" bgcolor="#F6F6F6">รหัสบัญชี :</td>
      <td height="28" colspan="3" bgcolor="#F6F6F6"><%=acctno%> - <%=doString.DisplayThai(doString.checkString(acct_desc))%></td>
    </tr>
  </table>
...
<br style="font-size:5pt">  
  ...
  <tr>
      <td width="10%" class="col_name1"><a href="#">วันที่</a></td>
      <td class="col_name1" width="5%"><a href="#">เลขที่รายการ</a></td>
      <td width="8%" class="col_name1"><a href="#">เลขที่ใบสำคัญ</a></td>
      <td width="12%" class="col_name1"><a href="#">เลขที่เช็ค</a></td>
...
<%
	  ...
	  sql.append("select doc_date, orig_journal, t_doc_no, ref_no, doc_desc, chq_no, z_amount, bus_name ")
		    .append("from lan:acxgldtl ")
			.append("where comp_id = '"+i_company+"' ")                                                                
			.append("and department = '"+i_project+"' ")
		    .append("and acct_no = '"+acctno+"' ");
if (month.equals("Q1")){  
       ...
       sql.append("and year(doc_date) = '"+(Integer.parseInt(year)-543)+"' ")
	        .append("order by doc_date, ref_no ");		 
	  ...
	  while (rs.next()) {
				...
				bus_name = doString.DisplayThai(doString.checkString(rs.getString("bus_name")));
				doc_desc = doString.DisplayThai(doString.checkString(rs.getString("doc_desc")));
...
<br style="font-size:5pt">
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" height="30">
          <tr>
            ...
            <td class="act_tab4"><a href="javascript:history.back()"><img border="0" src="images/bu_back.gif" width="50" height="15"></a><a href="EIS_Home.html"><img border="0" src="images/bu_home.gif" width="50" height="15"></a></td>  
          </tr>  
        </table>  
...
<%
	...
	System.out.println("!!!ERROR EIS_ExpenceMonthDetail.jsp : " + e.getMessage());
	System.out.println("!!!ERROR EIS_ExpenceMonthDetail.jsp SQL : " + sql.toString());
